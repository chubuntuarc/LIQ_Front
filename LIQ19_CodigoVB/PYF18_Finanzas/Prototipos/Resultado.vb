...
#Region "SUBS-PM"
    ...
    Private Sub PM_LI_FORMAT(ByRef PP_LI_LISTADO As DataGridView)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "CLAVE", "ID", GetType(Integer), 50, 2, 0, 1, 1, 0)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "EXITO", "Exito", GetType(String), 50, 2, 0, 1, 1, 0)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "MENSAJE", "Mensaje", GetType(String), 200, 2, 0, 1, 1, 0)
