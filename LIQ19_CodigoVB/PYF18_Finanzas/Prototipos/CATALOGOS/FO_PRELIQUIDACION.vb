...
#Region "SUBS_PM"
    ...
    Private Sub PM_LI_FORMAT(ByRef PP_LI_LISTADO As DataGridView)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D_PRELIQUIDACION", "Preliquidacion", GetType(String), 150, 1, 0, 1, 1, 0, Nothing, Nothing, 1)
    ...
    Private Sub PM_LI_FORMAT_DETALLE(ByRef PP_LI_DETALLE As DataGridView)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_DETALLE, "D_PRODUCTO", "Producto", GetType(String), 150, 1, 0, 1, 1, 0, Nothing, Nothing, 1)
