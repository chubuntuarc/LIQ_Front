Public Class FO_DATA_N1_X_DI_D0M4_FLUP
...
#Region "SUB_PM_INIT"
    ...
    Public Sub PM_CB_INIT()
        ...
        Codigo_CB.PG_CB_VALUE_LOAD(CB_LI_FORMATO_D0M4, "103")
...
#Region "SUBS_PM"
    ...
    Private Sub PM_LI_FORMAT(ByRef PP_LI_LISTADO As DataGridView)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "K_DOCUMENTO_D0M4", "#DOC", GetType(String), 60, 2, 0, 1, 1, 0, Color.White, Color.Black, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "K_DATO_D0M4", "#DATO", GetType(String), 60, 2, 0, 1, 1, 0, Color.White, Color.Black, 1)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "VALOR_ACUMULADO", "Acumulado", GetType(Decimal), 90, 3, 0, 1, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "DXX_VALOR", "DXX_VALOR", GetType(Decimal), 80, 3, 0, 0, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "DYY_VALOR", "DYY_VALOR", GetType(Decimal), 80, 3, 0, 0, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "DZZ_VALOR", "DZZ_VALOR", GetType(Decimal), 80, 3, 0, 0, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D01_VALOR", "Día 1", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D02_VALOR", "Día 2", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D03_VALOR", "Día 3", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D04_VALOR", "Día 4", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D05_VALOR", "Día 5", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D06_VALOR", "Día 6", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D07_VALOR", "Día 7", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D08_VALOR", "Día 8", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D09_VALOR", "Día 9", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D10_VALOR", "Día 10", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D11_VALOR", "Día 11", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D12_VALOR", "Día 12", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D13_VALOR", "Día 13", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D14_VALOR", "Día 14", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D15_VALOR", "Día 15", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D16_VALOR", "Día 16", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D17_VALOR", "Día 17", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D18_VALOR", "Día 18", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D19_VALOR", "Día 19", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D20_VALOR", "Día 20", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D21_VALOR", "Día 21", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D22_VALOR", "Día 22", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D23_VALOR", "Día 23", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D24_VALOR", "Día 24", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D25_VALOR", "Día 25", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D26_VALOR", "Día 26", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D27_VALOR", "Día 27", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D28_VALOR", "Día 28", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D29_VALOR", "Día 29", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D30_VALOR", "Día 30", GetType(Decimal), 80, 3, 1, 1, 0, 3)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D31_VALOR", "Día 31", GetType(Decimal), 80, 3, 1, 1, 0, 3)
    ...
    Public Sub PM_LI_ROW_WRITE(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW_DATA As DataRow)
        ...
        Dim VP_L_ALIGN As Integer = Codigo_LI.FG_LI_CELL_READ(PP_LISTADO, VP_ROW, "K_ALIGN")
        If VP_L_ALIGN = 3 Then
            For i As Integer = 3 To PP_LISTADO.Columns.Count - 1
                ...
                If i < 4 Then
                    PP_LISTADO.Rows(VP_ROW).Cells(i).Style.ForeColor = Color.Black
                End If
            Next
        End If

        Dim VP_K_DATO As Integer = Codigo_LI.FG_LI_CELL_READ(PP_LISTADO, VP_ROW, "K_DATO_D0M4")
        If VP_K_DATO = 3039 Then
            For i As Integer = 3 To PP_LISTADO.Columns.Count - 1
...
#Region "EVENTOS"
    ...
    Private Sub FO_DATA_N1_X_DI_D0M4_FLUP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        PM_FO_INIT(Me)
    End Sub
