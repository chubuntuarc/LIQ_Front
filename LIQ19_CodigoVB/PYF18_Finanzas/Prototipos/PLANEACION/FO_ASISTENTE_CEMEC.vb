...
Public Class FO_ASISTENTE_CEMEC
#Region "VARIABLES Y CONSTANTES MODULARES"
    ...
    Dim VM_PERFIL_VENTA_CREDITO As Integer = 0
    Dim VM_PERFIL_VENTA_CONTADO As Integer = 0
    Dim VM_PERFIL_COBRANZA As Integer = 0
...
#Region "FUNCIONES_FM"
    ...
    Public Function FM_LI_SQL_SAVE(ByVal PP_LI_LISTADO As DataGridView, ByVal PP_INDR As Integer) As String
        ...
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_LI_LISTADO.Rows(PP_INDR).Cells("K_DOCUMENTO_D0M4"), False)

        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_LI_LISTADO.Rows(PP_INDR).Cells("P2016_DTO_DESCUENTO_X_KG"), False)

        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_LI_LISTADO.Rows(PP_INDR).Cells("DESCUENTO_CONTADO_0_100"), False)

        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_LI_LISTADO.Rows(PP_INDR).Cells("P2023_PCN"), False)

        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_LI_LISTADO.Rows(PP_INDR).Cells("VENTA_PORCENTAJE_CONTADO_0_100"), False)

        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_LI_LISTADO.Rows(PP_INDR).Cells("DIV_VENTA_KG_TOTAL"), False)
        ...
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_LI_LISTADO.Rows(PP_INDR).Cells("COBRANZA_HOLGURA_0_100"), False)
...
#Region "SUB_PM_INIT"
    ...
    Public Sub PM_CB_INIT()
        ...
        Codigo_CB.PG_CB_LOAD_X_DESCRIPCION(VM_ID_BASE_DE_DATOS, Me, CB_LI_MES, "MES")
        Codigo_CB.PG_CB_LOAD_X_ORDEN(VM_ID_BASE_DE_DATOS, Me, CB_LI_ESTATUS_DOCUMENTO_D0M4)
        ...
        'GRAFICA INFERIOR
        Codigo_CB.PG_CB_ZONA_UO_Load(VM_ID_BASE_DE_DATOS, Me, CB_CEMEC_ZONA_UO, VG_USUARIO_ACCION)
        Codigo_CB.PG_CB_RAZON_SOCIAL_GASERAS_Load(VM_ID_BASE_DE_DATOS, Me, CB_CEMEC_RAZON_SOCIAL, 1, New ComboBox, VG_USUARIO_ACCION)
        Codigo_CB.PG_CB_UNIDAD_OPERATIVA_Load(VM_ID_BASE_DE_DATOS, Me, CB_CEMEC_UNIDAD_OPERATIVA, 0, 0, CB_CEMEC_ZONA_UO, CB_CEMEC_RAZON_SOCIAL, VG_USUARIO_ACCION)
        Codigo_CB.PG_CB_LOAD_X_ORDEN(VM_ID_BASE_DE_DATOS, Me, CB_CEMEC_TIEMPO_YYYY, "TIEMPO_YYYY")
        Codigo_CB.PG_CB_LOAD_X_ORDEN(VM_ID_BASE_DE_DATOS, Me, CB_CEMEC_MES, "MES")

        'CARGA DE VALORES EN COMBO
    ...
    Private Sub PM_GR_INIT(ByRef PP_GRAFICA As DataVisualization.Charting.Chart, ByVal PP_ANGULO_X As Integer)
        ...
        'PP_GRAFICA.ChartAreas(0).AxisY.StripLines(0).StripWidth = 1
        'PP_GRAFICA.ChartAreas(0).AxisY.StripLines(0).BackColor = Color.Gainsboro
        'PP_GRAFICA.ChartAreas(0).AxisY.LineColor = Color.Gainsboro
        'PP_GRAFICA.ChartAreas(0).AxisY.LineDashStyle = DataVisualization.Charting.ChartDashStyle.Dash
        'PP_GRAFICA.ChartAreas(0).AxisY2.ArrowStyle = DataVisualization.Charting.AxisArrowStyle.Lines
        'PP_GRAFICA.ChartAreas(0).AxisX2.ArrowStyle = DataVisualization.Charting.AxisArrowStyle.None
        ' PP_GRAFICA.ChartAreas(0).AxisX.LineWidth = 0
        'PP_GRAFICA.ChartAreas(0).AxisY.LineWidth = 0
        'PP_GRAFICA.ChartAreas(0).AxisX.LabelStyle.Enabled = False
        ...
        'PP_GRAFICA.ChartAreas(0).s
        'PP_GRAFICA.ChartAreas(0).AxisX.MinorGrid.Enabled = False
        ' PP_GRAFICA.ChartAreas(0).AxisY.MinorGrid.Enabled = True
        'PP_GRAFICA.ChartAreas(0).AxisX.MajorTickMark.Enabled = False
        'PP_GRAFICA.ChartAreas(0).AxisY.MajorTickMark.Enabled = False
        'PP_GRAFICA.ChartAreas(0).AxisX.MinorTickMark.Enabled = False
        'PP_GRAFICA.ChartAreas(0).AxisY.MinorTickMark.Enabled = False
...
#Region "SUBS_PM"
    ...
    Private Sub PM_LI_FORMAT(ByRef PP_LI_LISTADO As DataGridView)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "K_DOCUMENTO_D0M4", "#DOC", GetType(String), 40, 2, 0, 1, 1, 0, Color.White, Color.Black, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D_DOCUMENTO_D0M4", "DESCRIPCION", GetType(String), 170, 1, 0, 1, 1, 0, Nothing, Nothing, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "S_FORMATO_D0M4", "Tipo", GetType(String), 40, 2, 0, 1, 1, 0, Nothing, Nothing, 1)

        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "S_ZONA_UO", "Zona", GetType(String), 50, 2, 0, 1, 1, 0, Color.DarkOrange, Nothing, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "S_RAZON_SOCIAL", "Razón Social", GetType(String), 50, 2, 0, 1, 1, 0, Color.DarkOrange, Nothing, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "K_UNIDAD_OPERATIVA", "ID UNIDAD OPERATIVA", GetType(String), 80, 1, 0, 0, 1, 0)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "K_ESTATUS_DOCUMENTO_D0M4", "K_ESTATUS_DOCUMENTO_D0M4", GetType(Integer), 80, 2, 0, 0, 1, 0)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "S_ESTATUS_DOCUMENTO_D0M4", "Estatus", GetType(Integer), 60, 2, 0, 1, 1, 0, Color.DarkSlateGray, Color.Gainsboro, 1)

        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "K_YYYY", "Año", GetType(Integer), 40, 2, 0, 1, 1, 0, Color.DarkSlateGray, Color.Gainsboro, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "K_MM", "K_MM", GetType(Integer), 35, 2, 0, 0, 1, 0, Color.DarkSlateGray, Color.Gainsboro, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D_TIEMPO_MES", "Mes", GetType(String), 60, 2, 0, 1, 1, 0, Color.DarkSlateGray, Color.Gainsboro, 1)

        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "P2016_DTO_DESCUENTO_X_KG", "Descuento $/Kg", GetType(Decimal), 80, 3, 1, 1, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "DESCUENTO_CONTADO_0_100", "Descuento CON %", GetType(Decimal), 80, 2, 1, 1, 0, 1, Nothing, Color.LightYellow)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "DESCUENTO_CREDITO_0_100", "Descuento CRE %", GetType(Decimal), 80, 2, 0, 1, 0, 1, Color.Gray, Color.LightYellow)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "P2023_PCN", "PCN $", GetType(Decimal), 60, 3, 1, 1, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "VENTA_PORCENTAJE_CONTADO_0_100", "Venta CON %", GetType(Decimal), 80, 2, 1, 1, 0, 1, Nothing, Color.LightYellow)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "VENTA_PORCENTAJE_CREDITO_0_100", "Venta CRE %", GetType(Decimal), 80, 2, 0, 1, 0, 1, Color.Gray, Color.LightYellow)
        'Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "VENTA_KG_CONTADO", "Venta CON $", GetType(Decimal), 80, 2, 1, 1, 0, 1)
        'Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "VENTA_KG_CREDITO", "Venta CRE $", GetType(Decimal), 80, 2, 1, 1, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "DIV_VENTA_KG_CONTADO", "Venta CON $", GetType(Decimal), 80, 2, 0, 1, 0, 1, Color.Gray)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "DIV_VENTA_KG_CREDITO", "Venta CRE $", GetType(Decimal), 80, 2, 0, 1, 0, 1, Color.Gray)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "DIV_VENTA_KG_TOTAL", "Venta Total $", GetType(Decimal), 80, 2, 1, 1, 0, 1)


        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "P1012_CARTERA_CYC_INICIAL", "Cartera Inicial $", GetType(Decimal), 100, 3, 1, 1, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "P1013_CARTERA_CYC_FINAL", "Cartera Final $", GetType(Decimal), 100, 3, 1, 1, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "COBRANZA_HOLGURA_0_100", "Holgura Cobranza %", GetType(Decimal), 80, 2, 1, 1, 0, 1, Nothing, Color.LightYellow)

        VM_PERFIL_VENTA_CREDITO = Convert.ToInt16(CH_VENTA_CREDITO.Checked)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_1_LUNES", "Venta CON/Lun", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CREDITO, 0, 1, Nothing, Color.LightCyan)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_2_MARTES", "Venta CON/Mar", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CREDITO, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_3_MIERCOLES", "Venta CON/Mie", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CREDITO, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_4_JUEVES", "Venta CON/Jue", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CREDITO, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_5_VIERNES", "Venta CON/Vie", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CREDITO, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_6_SABADO", "Venta CON/Sab", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CREDITO, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_7_DOMINGO", "Venta CON/Dom", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CREDITO, 0, 1)

        VM_PERFIL_VENTA_CONTADO = Convert.ToInt16(CH_VENTA_CONTADO.Checked)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_1_LUNES", "Venta CRE/Lun", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CONTADO, 0, 1, Nothing, Color.LightCyan)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_2_MARTES", "Venta CRE/Mar", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CONTADO, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_3_MIERCOLES", "Venta CRE/Mie", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CONTADO, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_4_JUEVES", "Venta CRE/Jue", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CONTADO, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_5_VIERNES", "Venta CRE/Vie", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CONTADO, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_6_SABADO", "Venta CRE/Sab", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CONTADO, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_7_DOMINGO", "Venta CRE/Dom", GetType(Decimal), 70, 2, 1, VM_PERFIL_VENTA_CONTADO, 0, 1)

        VM_PERFIL_COBRANZA = Convert.ToInt16(CH_COBRANZA.Checked)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_1_LUNES", "Cobranza Lun", GetType(Decimal), 70, 2, 1, VM_PERFIL_COBRANZA, 0, 1, Nothing, Color.LightCyan)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_2_MARTES", "Cobranza Mar", GetType(Decimal), 70, 2, 1, VM_PERFIL_COBRANZA, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_3_MIERCOLES", "Cobranza Mie", GetType(Decimal), 70, 2, 1, VM_PERFIL_COBRANZA, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_4_JUEVES", "Cobranza Jue", GetType(Decimal), 70, 2, 1, VM_PERFIL_COBRANZA, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_5_VIERNES", "Cobranza Vie", GetType(Decimal), 70, 2, 1, VM_PERFIL_COBRANZA, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_6_SABADO", "Cobranza Sab", GetType(Decimal), 70, 2, 1, VM_PERFIL_COBRANZA, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_7_DOMINGO", "Cobranza Dom", GetType(Decimal), 70, 2, 1, VM_PERFIL_COBRANZA, 0, 1)
    ...
    Public Sub PM_LI_ROW_WRITE(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW_DATA As DataRow)
        ...
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "K_ESTATUS_DOCUMENTO_D0M4")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "S_ESTATUS_DOCUMENTO_D0M4")
        ...
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "D_TIEMPO_MES")
        ...
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "VENTA_PORCENTAJE_CONTADO_0_100")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "VENTA_PORCENTAJE_CREDITO_0_100")
        'Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "VENTA_KG_CONTADO")
        'Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "VENTA_KG_CREDITO")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "DIV_VENTA_KG_CONTADO")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "DIV_VENTA_KG_CREDITO")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "DIV_VENTA_KG_TOTAL")
    ...
    Private Sub PM_ACTUALIZAR_GRAFICA_3(ByRef PP_LISTADO As DataGridView, ByVal PP_ROW As Integer)
        ...
        Dim VP_K_DOCUMENTO_D0M4 As Integer = FM_ID_SELECCIONADO(PP_LISTADO, PP_ROW)

        PM_CARGAR_COMBOS_GRAFICA_4(PP_LISTADO, PP_ROW, VP_K_DOCUMENTO_D0M4)
        PM_ACTUALIZAR_GRAFICA_3(VP_K_DOCUMENTO_D0M4)

    End Sub

    Private Sub PM_CARGAR_COMBOS_GRAFICA_4(PP_LISTADO As DataGridView, PP_ROW As Integer, PP_K_DOCUMENTO_D0M4 As Integer)
        Dim VP_PARAMETROS As String = PP_K_DOCUMENTO_D0M4
        ' Codigo_CON.PG_SQL_PARAMETROS_CONTROL(VP_PARAMETROS)
        Dim VP_DATATABLE As New Data.DataTable
        Codigo_ABC.PG_BT_EJECUTAR_ACCION_TABLA_CLICK(VM_ID_BASE_DE_DATOS, Me, "PG_SK_DOCUMENTO_D0M4", VP_PARAMETROS, VP_DATATABLE)
        TB_CEMEC_K_DOCUMENTO_D0M4.Text = PP_K_DOCUMENTO_D0M4.ToString()
        Codigo_CB.PG_CB_VALUE_LOAD(CB_CEMEC_ZONA_UO, Codigo_LI.FG_LI_CELL_READ(VP_DATATABLE, 0, "K_ZONA_UO"))
        Codigo_CB.PG_CB_VALUE_LOAD(CB_GR_ZONA_UO, Codigo_LI.FG_LI_CELL_READ(VP_DATATABLE, 0, "K_ZONA_UO"))
        Codigo_CB.PG_CB_VALUE_LOAD(CB_CEMEC_RAZON_SOCIAL, Codigo_LI.FG_LI_CELL_READ(VP_DATATABLE, 0, "K_RAZON_SOCIAL"))
        Codigo_CB.PG_CB_VALUE_LOAD(CB_GR_RAZON_SOCIAL, Codigo_LI.FG_LI_CELL_READ(VP_DATATABLE, 0, "K_RAZON_SOCIAL"))
        Codigo_CB.PG_CB_UNIDAD_OPERATIVA_Load(VM_ID_BASE_DE_DATOS, Me, CB_CEMEC_UNIDAD_OPERATIVA, 0, 0, CB_CEMEC_ZONA_UO, CB_CEMEC_RAZON_SOCIAL, VG_USUARIO_ACCION)
        Codigo_CB.PG_CB_VALUE_LOAD(CB_CEMEC_UNIDAD_OPERATIVA, Codigo_LI.FG_LI_CELL_READ(VP_DATATABLE, 0, "K_UNIDAD_OPERATIVA"))
        Codigo_CB.PG_CB_VALUE_LOAD(CB_GR_UNIDAD_OPERATIVA, Codigo_LI.FG_LI_CELL_READ(VP_DATATABLE, 0, "K_UNIDAD_OPERATIVA"))
        'Codigo_CB.PG_CB_VALUE_LOAD(CB_CEMEC_ZONA_UO, Codigo_LI.FG_LI_CELL_READ(PP_LISTADO, 0, "K_RAZON_SOCIAL"))
        Codigo_CB.PG_CB_VALUE_LOAD(CB_CEMEC_TIEMPO_YYYY, Codigo_LI.FG_LI_CELL_READ(VP_DATATABLE, 0, "K_YYYY"))
        Codigo_CB.PG_CB_VALUE_LOAD(CB_CEMEC_MES, Codigo_LI.FG_LI_CELL_READ(VP_DATATABLE, 0, "K_MM"))
    End Sub

    Private Sub PM_ACTUALIZAR_GRAFICA_3(ByVal PP_K_DOCUMENTO_D0M4 As Integer)
        Dim VP_PARAMETROS As String = ""
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_CEMEC_ZONA_UO, False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_CEMEC_RAZON_SOCIAL, False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_CEMEC_UNIDAD_OPERATIVA, False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_CEMEC_TIEMPO_YYYY, False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_CEMEC_MES, False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_K_DOCUMENTO_D0M4, False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_DIVISOR, False)
    ...
    Private Sub PM_CARGAR_GRAFICA_3(ByVal PP_PARAMETROS As String)
        ...
        Dim VP_DATATABLE As New DataTable '= Codigo_CON.FG_SP_EXECUTE_DATATABLE(VG_ID_DB, "[PG_GR_004_VENTA_CEMEC]", PP_PARAMETROS)
        PM_GR_INIT(GR_GRAFICA_3, -90)
        'Codigo_ABC.PG_BT_GRAFICAR_CLICK(GR_GRAFICA_3, VP_DATATABLE, DataVisualization.Charting.SeriesChartType.Spline, 0, 1)
        Codigo_ABC.PG_BT_GRAFICAR_CLICK(VM_ID_BASE_DE_DATOS, Me, GR_GRAFICA_3, "SLíneas", PP_PARAMETROS, "PG_GR_004_VENTA_CEMEC")
        ' Codigo_ABC.PG_BT_GRAFICAR_CLICK(GR_GRAFICA_3, VP_DATATABLE, DataVisualization.Charting.SeriesChartType.Spline, 0, ByVal PP_COLUMNA_1 As Integer, ByVal PP_COLUMNA_2 As Integer)
    End Sub
        ...
        Try
            ...
            For Each VP_FILA In PP_LISTADO.Rows
                ...
                If VP_DATO = 1 Then
                    ...
                    Codigo_ABC.PG_BT_EJECUTAR_ACCION_CLICK(VM_ID_BASE_DE_DATOS, PP_FORMA, "[PG_UP_CEMEC_PARAMETROS_VARIACION]", VP_PARAMETROS, VP_CLAVE, VP_MENSAJE)
                    If VP_MENSAJE <> "" Then
    ...
    Private Sub PM_REPROCESAR(PP_FORMA As Object, PP_LISTADO As DataGridView)
        If Codigo_Message.FG_MENSAJE_CONFIRMACION("¿Desea <Reprocesar Cédula/Flujo> de compromiso de Ventas, de los Documentos seleccionados?") Then
            Me.Cursor = Cursors.WaitCursor
            Try
                For Each VP_K_DOCUMENTO_D0M4 As Integer In VM_PLAN_POV_IDS
                    Dim VP_CLAVE As Integer = 0
                    Dim VP_MENSAJE As String = ""
                    Dim VP_PARAMETROS As String = ""

                    Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, VP_K_DOCUMENTO_D0M4, False)
                    Codigo_ABC.PG_BT_EJECUTAR_ACCION_CLICK(VM_ID_BASE_DE_DATOS, PP_FORMA, "[PG_PR_CEMEC_CALCULOS_REPROCESAR]", VP_PARAMETROS, VP_CLAVE, VP_MENSAJE)
                    If VP_MENSAJE <> "" Then
            ...
            Codigo_Message.PG_MENSAJE_INFORMACION("<Reproceso Cédula/Flujo> de Compromiso de Ventas finalizado")
    ...
    '        Dim VP_D_TEMPORADA As String = Codigo_CB.FG_CB_ITEM_TEXT(CB_LI_MES)
    ...
    Private Sub PM_BT_CEMEC_MASIVO_CLICK(PP_FORMA As Object, PP_LISTADO As DataGridView, PP_K_ZONA_UO As Integer, PP_K_RAZON_SOCIAL As Integer, PP_K_UNIDAD_OPERATIVA As Integer, PP_ST_MENSAJE As String)
        Try
            '    Dim VP_D_YYYY As String = Codigo_CB.FG_CB_ITEM_TEXT(CB_LI_TIEMPO_YYYY)
            ...
            If Codigo_Message.FG_MENSAJE_CONFIRMACION(PP_ST_MENSAJE) Then
                ...
                Dim VP_K_MES As Integer = Codigo_CB.FG_CB_ITEM_VALUE(CB_LI_MES)

                If VP_K_TIEMPO_YYYY = -1 Or VP_K_MES = -1 Then
                    Codigo_Message.PG_MENSAJE_AVISO("No es posible completar la operación, seleccione un año y mes válidos")
                Else
                    Dim VP_TABLA As New DataTable
                    ...
                    If VP_TABLA.Rows.Count > 0 Then
                        ...
                        While VP_CONTADOR < VP_CONTADOR_REGISTROS
                            ...
                            Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS_LOTE, VP_K_MES, False)
                            Codigo_ABC.PG_BT_EJECUTAR_ACCION_CLICK(VM_ID_BASE_DE_DATOS, PP_FORMA, "[PG_PR_CEMEC_FLUP_MASIVO]", VP_PARAMETROS_LOTE, VP_CLAVE, VP_MENSAJE)
                            If VP_MENSAJE <> "" Then
                                Codigo_Message.PG_MENSAJE_AVISO(VP_MENSAJE)
                            End If
                            VP_CONTADOR += 1
                    ...
                    End If
                    Codigo_Message.PG_MENSAJE_INFORMACION("<Generación Cédula> de Compromiso de Ventas y Flujo Proyectado finalizado.")
                    PM_BT_BUSCAR_CLICK(PP_FORMA, PP_LISTADO)
                End If
                Me.Cursor = Cursors.Default
            End If
...
#Region "EVENTOS BOTONES"
    ...
    Private Sub TB_CEMEC_K_PLAN_POV_KeyUp(sender As Object, e As KeyEventArgs) Handles TB_CEMEC_K_DOCUMENTO_D0M4.KeyUp
    ...
    Private Sub BT_GENERAR_ZONA_UO_Click(sender As Object, e As EventArgs) Handles BT_GENERAR_ZONA_UO.Click
        ...
        Else
            Dim VP_D_YYYY As String = Codigo_CB.FG_CB_ITEM_TEXT(CB_LI_TIEMPO_YYYY)
            Dim VP_D_ZONA_UO As String = Codigo_CB.FG_CB_ITEM_TEXT(CB_LI_ZONA_UO)
            Dim VP_D_MES As String = Codigo_CB.FG_CB_ITEM_TEXT(CB_LI_MES)
            Dim VP_MENSAJE = "¿Desea <Generar Cédula> de Compromiso de Ventas y Flujo Proyectado? " + vbCrLf + vbCrLf + " -Zona:= " + VP_D_ZONA_UO + vbCrLf + " -Año:= " + VP_D_YYYY + vbCrLf + " -Mes:= " + VP_D_MES + vbCrLf + vbCrLf + "IMPORTANTE: La información actual será borrada."
            PM_BT_CEMEC_MASIVO_CLICK(Me, LI_LISTADO, Codigo_CB.FG_CB_ITEM_VALUE(CB_LI_ZONA_UO), -1, -1, VP_MENSAJE)
        End If
    End Sub
    ...
    Private Sub BT_GENERAR_RAZON_SOCIAL_Click(sender As Object, e As EventArgs) Handles BT_GENERAR_RAZON_SOCIAL.Click
        ...
        Else
            ...
            Dim VP_D_RAZON_SOCIAL As String = Codigo_CB.FG_CB_ITEM_TEXT(CB_LI_RAZON_SOCIAL)
            Dim VP_D_MES As String = Codigo_CB.FG_CB_ITEM_TEXT(CB_LI_MES)
            Dim VP_MENSAJE = "¿Desea <Generar Cédula> de Compromiso de Ventas y Flujo Proyectado? " + vbCrLf + vbCrLf + " -Razón Social:= " + VP_D_RAZON_SOCIAL + vbCrLf + " -Año:= " + VP_D_YYYY + vbCrLf + " -Mes:= " + VP_D_MES + vbCrLf + vbCrLf + "IMPORTANTE: La información actual será borrada."
            PM_BT_CEMEC_MASIVO_CLICK(Me, LI_LISTADO, -1, Codigo_CB.FG_CB_ITEM_VALUE(CB_LI_RAZON_SOCIAL), -1, VP_MENSAJE)
        End If
    End Sub
    ...
    Private Sub BT_GENERAR_UNIDAD_OPERATIVA_Click(sender As Object, e As EventArgs) Handles BT_GENERAR_UNIDAD_OPERATIVA.Click
        ...
        Else
            ...
            Dim VP_D_MES As String = Codigo_CB.FG_CB_ITEM_TEXT(CB_LI_MES)
            Dim VP_MENSAJE = "¿Desea <Generar Cédula> de Compromiso de Ventas y Flujo Proyectado? " + vbCrLf + vbCrLf + " -Unidad Operativa:= " + VP_D_UNIDAD_OPERATIVA + vbCrLf + " -Año:= " + VP_D_YYYY + vbCrLf + " -Mes:= " + VP_D_MES + vbCrLf + vbCrLf + "IMPORTANTE: La información actual será borrada."
            PM_BT_CEMEC_MASIVO_CLICK(Me, LI_LISTADO, -1, -1, Codigo_CB.FG_CB_ITEM_VALUE(CB_LI_UNIDAD_OPERATIVA), VP_MENSAJE)
        End If
    End Sub
...
#Region "EVENTOS COMBOS"
    ...
    Private Sub CB_GR_ZONA_UO_SelectedValueChanged(sender As Object, e As EventArgs) Handles CB_GR_ZONA_UO.SelectedValueChanged, CB_GR_RAZON_SOCIAL.SelectedValueChanged
        If Me.Visible Then
            Codigo_CB.PG_CB_UNIDAD_OPERATIVA_Load(VM_ID_BASE_DE_DATOS, Me, CB_GR_UNIDAD_OPERATIVA, 1, 0, CB_GR_ZONA_UO, CB_GR_RAZON_SOCIAL, VG_USUARIO_ACCION)
            PM_ACTUALIZAR_GRAFICA_1()
            PM_ACTUALIZAR_GRAFICA_2()
    ...
    Private Sub CB_GR_UNIDAD_OPERATIVA_SelectedValueChanged(sender As Object, e As EventArgs) Handles CB_GR_UNIDAD_OPERATIVA.SelectedValueChanged,
        CB_GR_LI_TEMPORADA.SelectedValueChanged, CB_DIVISOR.SelectedValueChanged, CB_YYYY_INICIAL.SelectedValueChanged, CB_YYYY_FINAL.SelectedValueChanged
        If Me.Visible Then
            PM_ACTUALIZAR_GRAFICA_1()
            PM_ACTUALIZAR_GRAFICA_2()
        End If
    ...
    Private Sub CB_CEMEC_LI_ZONA_UO_SelectedValueChanged(sender As Object, e As EventArgs) Handles CB_CEMEC_ZONA_UO.SelectedValueChanged, CB_CEMEC_RAZON_SOCIAL.SelectedValueChanged
        If Me.Visible Then
            Codigo_CB.PG_CB_UNIDAD_OPERATIVA_Load(VM_ID_BASE_DE_DATOS, Me, CB_CEMEC_UNIDAD_OPERATIVA, 0, 0, CB_CEMEC_ZONA_UO, CB_CEMEC_RAZON_SOCIAL, VG_USUARIO_ACCION)
            PM_ACTUALIZAR_GRAFICA_1()
            PM_ACTUALIZAR_GRAFICA_2()
            PM_ACTUALIZAR_GRAFICA_3(0)
        End If
    End Sub

    Private Sub CB_CEMEC_TIEMPO_YYYY_SelectedValueChanged(sender As Object, e As EventArgs) Handles CB_CEMEC_TIEMPO_YYYY.SelectedValueChanged,
        CB_CEMEC_MES.SelectedValueChanged, CB_CEMEC_UNIDAD_OPERATIVA.SelectedValueChanged
        If Me.Visible And VM_BANDERA_CARGAR_GRAFICA_3 = 0 Then
            PM_ACTUALIZAR_GRAFICA_3(0)
        End If
    End Sub

    Private Sub CB_LI_ZONA_UO_SelectedValueChanged(sender As Object, e As EventArgs) Handles CB_LI_ZONA_UO.SelectedValueChanged, CB_LI_ZONA_UO.SelectedValueChanged
        If Me.Visible Then
            Codigo_CB.PG_CB_UNIDAD_OPERATIVA_Load(VM_ID_BASE_DE_DATOS, Me, CB_LI_UNIDAD_OPERATIVA, 1, 0, CB_LI_ZONA_UO, CB_LI_RAZON_SOCIAL, VG_USUARIO_ACCION)
        End If
