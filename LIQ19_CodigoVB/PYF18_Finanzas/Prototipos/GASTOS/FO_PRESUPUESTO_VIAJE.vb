Public Class FO_PRESUPUESTO_VIAJE
...
#Region "FUNCIONES_FM"
    ...
    Public Function FM_FI_SQL(ByRef PP_NUEVO As Boolean)
        Dim VP_PARAMETROS = ""
        PP_NUEVO = True
        If TB_K_PRESUPUESTO_VIAJE.Text <> "" Then
            Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, TB_K_PRESUPUESTO_VIAJE, False)
            PP_NUEVO = False
        End If
        ...
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, TB_MONTO_PROPUESTO, False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, TB_C_PRESUPUESTO_VIAJE, True)
    ...
    Public Function FM_ID_SELECCIONADO(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW As Integer) As String
        Dim VP_ID As String = ""
        VP_ID = Codigo_LI.FG_LI_CELL_READ(PP_LISTADO, PP_ROW, "K_PRESUPUESTO_VIAJE")
        Return VP_ID
    End Function
    ...
    Public Function FM_SAVE_VALIDATE(ByRef PP_MENSAJE_VALIDACION As String) As Boolean
        ...
        If VM_CB_VALUE_RS > 0 Then
            If VM_CB_VALUE_UO > 0 Then
                ...
                Codigo_CTRL.PG_TB_NUMERIC_VALIDATE(PP_MENSAJE_VALIDACION, TB_MONTO_PROPUESTO)
                Codigo_CTRL.PG_TB_DATE_VALIDATE(PP_MENSAJE_VALIDACION, TB_F_PRESUPUESTO_VIAJE)
...
#Region "SUBS_PM"
    ...
    Public Sub PM_FI_CARGAR(ByVal PP_ROW As DataRow)
        ...
        Codigo_CTRL.PG_CO_DATA_LOAD("", TB_K_PRESUPUESTO_VIAJE, PP_ROW)
        ...
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_MONTO_PROPUESTO, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("", TB_F_PRESUPUESTO_VIAJE, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("", TB_C_PRESUPUESTO_VIAJE, PP_ROW)
    ...
    Private Sub PM_LI_FORMAT(ByRef PP_LI_LISTADO As DataGridView)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "K_PRESUPUESTO_VIAJE", "#PrV", GetType(Integer), 60, 2, 0, 1, 1, 0, Color.White, Color.Black, 1)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "F_PRESUPUESTO_VIAJE_DDMMMYYYY", "Fecha", GetType(Date), 100, 2, 0, 1, 1, 0, Color.Orange, Nothing, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "MONTO_PROPUESTO", "Monto", GetType(Decimal), 80, 3, 0, 1, 0, 2)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "C_PRESUPUESTO_VIAJE", "Comentarios", GetType(String), 220, 1, 0, 1, 0, 0)
    ...
    Public Sub PM_LI_ROW_WRITE(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW_DATA As DataRow)
        ...
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "F_PRESUPUESTO_VIAJE_DDMMMYYYY")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "MONTO_PROPUESTO")
        ...
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "C_PRESUPUESTO_VIAJE")
    End Sub
