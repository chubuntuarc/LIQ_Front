...
Public Class Codigo_FRM
    ...
    Public Shared Sub PG_FRM_ABRIR(ByRef PP_FORMA As Object, ByRef PP_FORMA_NUEVA As Object, ByRef PP_NOMBRE_TABLA As String, ByVal PP_TITULO_TABPAGE As String, ByVal PP_ID_BASE_DE_DATOS As String, Optional ByVal PP_ES_MENU As Boolean = False, Optional ByVal PP_INICIALIZADA As Boolean = False)
        Dim TP_TAB_PAGE As TabPage = PP_FORMA.Parent
        Dim TC_MAIN_TABCONTROL As TabControlEx = TP_TAB_PAGE.Parent
        Codigo_FRM.PG_FO_SHOW(PP_FORMA_NUEVA, PP_NOMBRE_TABLA, PP_TITULO_TABPAGE, PP_ID_BASE_DE_DATOS, TC_MAIN_TABCONTROL, PP_ES_MENU, PP_INICIALIZADA)
    End Sub

    Public Shared Sub PG_FO_SHOW(ByRef PP_FORMA As Object, ByRef PP_NOMBRE_TABLA As String, ByVal PP_ID_BASE_DE_DATOS As String, ByRef PP_PANEL As Panel)
        PP_FORMA.Visible = False
        PP_FORMA.AutoSizeMode = AutoSizeMode.GrowAndShrink
        PP_FORMA.VM_NOMBRE_TABLA = PP_NOMBRE_TABLA
        PP_FORMA.VM_ID_BASE_DE_DATOS = PP_ID_BASE_DE_DATOS
        ...
        PG_FO_TITLE_SET(PP_ID_BASE_DE_DATOS, PP_FORMA, PP_PANEL)
    ...
    Public Shared Sub PG_FO_SHOW(ByRef PP_FORMA As Object, ByRef PP_NOMBRE_TABLA As String, ByVal PP_TITULO_TAB_PAGE As String, ByVal PP_ID_BASE_DE_DATOS As String, ByRef PP_MAIN_TABCONTROL As TabControl, Optional ByVal PP_ES_MENU As Boolean = False, Optional PP_INICIALIZADA As Boolean = False)
        ...
        If PP_ES_MENU Then
            ...
            VP_FORMA.VM_ID_BASE_DE_DATOS = PP_ID_BASE_DE_DATOS
    ...
    Public Shared Sub PG_FO_TITLE_SET(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_PANEL As Panel)

        On Error Resume Next
        Dim VP_TITULO As String = ""
        Dim VP_DB As String = ""
        Dim VP_SERVER As String = ""
        Codigo_CON.FG_CONNECTION_GET(PP_ID_BASE_DE_DATOS, VP_SERVER, VP_DB)
        VP_TITULO = Constantes_Sistema.CG_TITULO_VENTANA + " | " + PP_FORMA.Text + " [ Server: " + VP_SERVER + " | Base de Datos: " + VP_DB + " ]"
        PP_FORMA.VM_D_BASE_DE_DATOS = VP_DB
    ...
    Public Shared Sub PG_FRM_TITLE_CHANGE(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object)
        Dim VP_DB As String = ""
        Dim VP_SERVER As String = ""
        Codigo_CON.FG_CONNECTION_GET(PP_ID_BASE_DE_DATOS, VP_SERVER, VP_DB)
        PP_FORMA.Text = Constantes_Sistema.CG_TITULO_VENTANA + " | " + PP_FORMA.Text + " [ Server: " + VP_SERVER + " | Base de Datos: " + VP_DB + " ]"
    ...
    Public Shared Sub PG_FRM_CONFIG(ByRef PP_FORMA As Object)
        ...
        On Error Resume Next
        'PP_FORMA.Visible = False
        PP_FORMA.BT_AGREGAR.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Listado Or VP_IN_MODO_OPERACION = Modo_Operacion.Ver_Ficha)
        PP_FORMA.BT_EDITAR.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Listado Or VP_IN_MODO_OPERACION = Modo_Operacion.Ver_Ficha)
        PP_FORMA.BT_ELIMINAR.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Listado Or VP_IN_MODO_OPERACION = Modo_Operacion.Ver_Ficha)
        PP_FORMA.BT_GUARDAR.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Edición Or VP_IN_MODO_OPERACION = Modo_Operacion.Clon)
        PP_FORMA.BT_CANCELAR.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Edición Or VP_IN_MODO_OPERACION = Modo_Operacion.Clon)
        PP_FORMA.BT_SALIR.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Listado)
        PP_FORMA.BT_LISTADO.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Ver_Ficha)
        PP_FORMA.BT_EXPORTAR_EXCEL.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Listado)
        PP_FORMA.GB_FICHA.Visible = (VP_IN_MODO_OPERACION <> Modo_Operacion.Listado)
        PP_FORMA.GB_FICHA.Visible = (VP_IN_MODO_OPERACION <> Modo_Operacion.Listado)
        PP_FORMA.GB_LISTADO.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Listado)
        PP_FORMA.GB_FILTROS.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Listado)
        'PP_FORMA.GB_PYC.Visible = (VP_IN_MODO_OPERACION = 4)
        PP_FORMA.PG_FRM_CONFIG()
        Codigo_FI.PG_CN_CONFIG(PP_FORMA)
        If VP_IN_MODO_OPERACION = Modo_Operacion.Listado Then
    ...
    Public Shared Sub PG_FRM_CONFIG_FICHA(ByRef PP_FORMA As Object)
        ...
        PP_FORMA.BT_GUARDAR.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Edición Or VP_IN_MODO_OPERACION = Modo_Operacion.Clon)
        PP_FORMA.BT_CANCELAR.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Edición Or VP_IN_MODO_OPERACION = Modo_Operacion.Clon)
        PP_FORMA.BT_SALIR.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Edición Or VP_IN_MODO_OPERACION = Modo_Operacion.Clon)
        PP_FORMA.BT_LISTADO.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Ver_Ficha)
        PP_FORMA.BT_EXPORTAR_EXCEL.Enabled = (VP_IN_MODO_OPERACION = Modo_Operacion.Listado)
        PP_FORMA.GB_FICHA.Visible = (VP_IN_MODO_OPERACION <> Modo_Operacion.Listado)
    ...
    Public Shared Sub PG_FRM_INIT(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object)
        On Error Resume Next
        PP_FORMA.Visible = False
        PG_FRM_INIT_BASIC(PP_FORMA)
        PG_FRM_TITLE_CHANGE(PP_ID_BASE_DE_DATOS, PP_FORMA)
    ...
    Public Shared Sub PG_FRM_INIT_FICHA(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object)
        On Error Resume Next
        PP_FORMA.Visible = False
        PG_FRM_INIT_BASIC(PP_FORMA)
        PG_FRM_TITLE_CHANGE(PP_ID_BASE_DE_DATOS, PP_FORMA)
    ...
    Private Shared Sub LimpiarCombos(sender As Object, e As KeyPressEventArgs)

        Dim lola As Object = sender
