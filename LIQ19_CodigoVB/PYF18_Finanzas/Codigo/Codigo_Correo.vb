...
Public Class Codigo_Correo
    Public Shared Sub PG_ENVIAR_CORREO(ByVal PP_ASUNTO As String, ByVal PP_DESTINATARIO As String,
        ...
        Else
            Codigo_Message.PG_MENSAJE_AVISO("Archivo no encontrado")
        ...
        Try
            _SMTP.Send(_Message)
            Codigo_Message.PG_MENSAJE_INFORMACION("Se ha enviado el correo exitosamente.")
        Catch ex As Exception
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_ENVIAR_CORREO")
        End Try
    End Sub
