...
#Region "CONEXION"
    ...
    Public Shared Function PG_CONNECTION_INIT() As List(Of CG_SQL_CONEXION)
        ...
        Try
            ...
            VP_CONTADOR += 1
            CG_LISTADO_CONEXION.Add(New CG_SQL_CONEXION(VP_CONTADOR, "DESKTOP-FTVBJI8\SQLEXPRESS", "PYF18_Finanzas_V0043_R0", "sa", "ilAgrA", 0))
            VP_CONTADOR += 1
            CG_LISTADO_CONEXION.Add(New CG_SQL_CONEXION(VP_CONTADOR, "DESKTOP-KTP3PGG\SQLEXPRESS", "PYF18_Finanzas_V0042_R0", "sa", "JI-15186#KF", 0))
            VP_CONTADOR += 1
            CG_LISTADO_CONEXION.Add(New CG_SQL_CONEXION(VP_CONTADOR, "DESKTOP-FTVBJI8\SQLEXPRESS", "PYF18_Finanzas_V9999_R0", "sa", "ilAgrA", 0))
            VP_CONTADOR += 1
            CG_LISTADO_CONEXION.Add(New CG_SQL_CONEXION(VP_CONTADOR, "DESKTOP-KTP3PGG\SQLEXPRESS", "PYF18_Finanzas_V0038_R0", "sa", "JI-15186#KF", 0))
            VP_CONTADOR += 1
            CG_LISTADO_CONEXION.Add(New CG_SQL_CONEXION(VP_CONTADOR, "DESKTOP-FTVBJI8\SQLEXPRESS", "PYF18_Finanzas_V0038_R0", "sa", "ilAgrA", 0))
            VP_CONTADOR += 1
            CG_LISTADO_CONEXION.Add(New CG_SQL_CONEXION(VP_CONTADOR, "DESKTOP-KTP3PGG\SQLEXPRESS", "PYF18_Finanzas_V0037_R0", "sa", "JI-15186#KF", 0))
            VP_CONTADOR += 1
            CG_LISTADO_CONEXION.Add(New CG_SQL_CONEXION(VP_CONTADOR, "DESKTOP-KTP3PGG\SQLEXPRESS", "PYF18_Finanzas_V0036_R0", "sa", "JI-15186#KF", 0))
            VP_CONTADOR += 1
            CG_LISTADO_CONEXION.Add(New CG_SQL_CONEXION(VP_CONTADOR, "DESKTOP-KTP3PGG\SQLEXPRESS", "PYF18_Finanzas_V0035_R0", "sa", "JI-15186#KF", 0))
            VP_CONTADOR += 1
            CG_LISTADO_CONEXION.Add(New CG_SQL_CONEXION(VP_CONTADOR, "DESKTOP-KTP3PGG\SQLEXPRESS", "PYF18_Finanzas_V0034_R0", "sa", "JI-15186#KF", 0))
