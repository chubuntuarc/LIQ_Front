Public Class FO_FICHA_ESTACION_CARBURACION
...
#Region "FUNCIONES_FM"
    ...
    Public Function FM_FI_SQL(ByRef PP_NUEVO As Boolean)
        ...
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_MEDIDOR, False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_TIPO_MEDIDOR, False)
...
#Region "SUB_PM_INIT"
    ...
    Public Sub PM_CB_INIT()
        ...
        Codigo_CB.PG_CB_VALUE_LOAD(CB_LI_TIPO_PUNTO_VENTA, 2)
        ...
        Codigo_CB.PG_CB_VALUE_LOAD(CB_TIPO_PUNTO_VENTA, 2)
        Codigo_TOMZA.PG_CB_UNIDAD_OPERATIVA_x_AccesoLoad(VM_ID_BASE_DE_DATOS, Me, CB_UNIDAD_OPERATIVA, 0, VG_USUARIO_ACCION)
        ...
        Codigo_CB.PG_CB_LOAD_X_ORDEN(VM_ID_BASE_DE_DATOS, Me, CB_MEDIDOR, "")
        Codigo_CB.PG_CB_LOAD_X_ORDEN(VM_ID_BASE_DE_DATOS, Me, CB_TIPO_MEDIDOR, "")
    ...
    Public Sub PM_LI_INIT()
        ...
        Dim VP_PARAMETROS_DETALLE As String = "'',-1,2,-1"
        ...
        Dim VM_CAMPOS As New ArrayList From {"K_PUNTO_VENTA", "D_UNIDAD_OPERATIVA", "D_PUNTO_VENTA", "S_ESTATUS_PUNTO_VENTA", "OPERADOR_NOMBRE", "CAPACIDAD_ESTACION", "PORCENTAJE_ESTACION", "LECTURA_INICIAL_ESTACION", "LECTURA_FINAL_ESTACION", "DIRECCION", "D_MEDIDOR", "D_TIPO_MEDIDOR"}
        Dim VM_TITULOS As New ArrayList From {"PDV", "Unidad operativa", "Descripción", "Estatus", "Operador", "Capacidad", "Porcentaje", "Lectura Inicial", "Lectura Final", "Dirección", "Medidor", "Tipo de Medidor"}
        '///  K--ID | D--DESCRIPCION | S--SIGLAS | ESTATUS | GENERAL | CENTRADO | LECTURA | SERIE
        Dim VM_TIPOS As New ArrayList From {"K", "D", "D", "ESTATUS", "GENERAL", "CENTRADO LARGO", "PORCENTAJE", "LECTURA", "LECTURA", "CENTRADO LARGO", "GENERAL", "GENERAL"}
    ...
    Public Sub PM_TB_INIT()
        ...
        LIQ19_Codigo.PG_TB_INIT(TB_DIRECCION, 3)
...
#Region "SUBS_PM"
    ...
    Public Sub PM_FI_LOAD(ByVal PP_ID As String)
        ...
        If PP_ID <> "" Then
            ...
            VP_RESULTADO_AUTOTANQUE = Codigo_SQL.FG_SP_EXECUTE_DATATABLE(VM_ID_BASE_DE_DATOS, "PG_SK_FICHA_ESTACION_CARBURACION", VP_PARAMETROS)
            ...
            If VP_RESULTADO_AUTOTANQUE.Rows.Count <> 0 Then
                ...
                TB_DIRECCION.Text = VP_ROW_AUT("DIRECCION").ToString()
                TB_CAPACIDAD.Text = VP_ROW_AUT("CAPACIDAD").ToString()
                TB_PORCENTAJE.Text = VP_ROW_AUT("PORCENTAJE").ToString()
                Codigo_CB.PG_CB_VALUE_LOAD(CB_MEDIDOR, Integer.Parse(VP_ROW_AUT("K_MEDIDOR")))
                Codigo_CB.PG_CB_VALUE_LOAD(CB_TIPO_MEDIDOR, Integer.Parse(VP_ROW_AUT("K_TIPO_MEDIDOR")))
            End If
    ...
    Public Sub PM_LI_ROW_WRITE(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW_DATA As DataRow)
        ...
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "CAPACIDAD_ESTACION")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "PORCENTAJE_ESTACION")

        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "LECTURA_INICIAL_ESTACION")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "LECTURA_FINAL_ESTACION")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "DIRECCION")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "D_MEDIDOR")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "D_TIPO_MEDIDOR")
...
#Region "EVENTOS"
    ...
    Private Sub CB_LI_ZONA_UO_DropDown(sender As Object, e As EventArgs) Handles CB_LI_ZONA_UO.DropDown
        Codigo_LI.PG_LI_CLEAR(LI_LISTADO)
    End Sub

    Private Sub CB_LI_RAZON_SOCIAL_DropDown(sender As Object, e As EventArgs) Handles CB_LI_RAZON_SOCIAL.DropDown
        Codigo_LI.PG_LI_CLEAR(LI_LISTADO)
    End Sub
    ...
    Private Sub CB_LI_ESTATUS_PUNTO_VENTA_DropDown(sender As Object, e As EventArgs) Handles CB_LI_ESTATUS_PUNTO_VENTA.DropDown
        Codigo_LI.PG_LI_CLEAR(LI_LISTADO)
    End Sub
