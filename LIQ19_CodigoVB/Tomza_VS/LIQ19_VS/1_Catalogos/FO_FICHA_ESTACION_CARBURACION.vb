...
#Region "SUB_PM_INIT"
    ...
    Public Sub PM_CB_INIT()
        ...
        CB_LI_TIPO_PUNTO_VENTA.SelectedIndex = 2
    ...
    Public Sub PM_LI_INIT()
        ...
        Dim VM_CAMPOS As New ArrayList From {"K_PUNTO_VENTA", "D_PUNTO_VENTA", "S_ESTATUS_PUNTO_VENTA", "OPERADOR_NOMBRE", "D_UNIDAD_OPERATIVA", "LECTURA_INICIAL_ESTACION", "LECTURA_FINAL_ESTACION", "DIRECCION", "CAPACIDAD_ESTACION", "PORCENTAJE_ESTACION", "D_MEDIDOR", "D_TIPO_MEDIDOR"}
        Dim VM_TITULOS As New ArrayList From {"PDV", "Descripción", "Estatus", "Operador", "Unidad operativa", "Lectura Inicial", "Lectura Final", "Dirección", "Capacidad", "Porcentaje", "Medidor", "Tipo de Medidor"}
        '///  K--ID | D--DESCRIPCION | S--SIGLAS | ESTATUS | GENERAL | CENTRADO | LECTURA | SERIE
        Dim VM_TIPOS As New ArrayList From {"K", "D", "ESTATUS", "GENERAL", "GENERAL", "LECTURA", "LECTURA", "CENTRADO LARGO", "CENTRADO LARGO", "PORCENTAJE", "GENERAL", "GENERAL"}
