...
#Region "SUB_PM_INIT"
    ...
    Public Sub PM_CB_INIT()
        ...
        CB_TIPO_PUNTO_VENTA.SelectedIndex = 2
    ...
    Public Sub PM_LI_INIT()
        ...
        Dim VM_CAMPOS As New ArrayList From {"K_PUNTO_VENTA", "D_PUNTO_VENTA", "S_ESTATUS_PUNTO_VENTA", "OPERADOR_NOMBRE", "D_UNIDAD_OPERATIVA"}
        Dim VM_TITULOS As New ArrayList From {"#PDV", "Descripción", "Estatus", "Operador", "Unidad operativa"}
        Dim VM_TIPOS As New ArrayList From {1, 2, 3, 4, 4} '///  1 | ID -- 2 | DESCRIPCION -- 3 | ESTATUS -- 4 | GENERAL -- 5 | SIGLAS
