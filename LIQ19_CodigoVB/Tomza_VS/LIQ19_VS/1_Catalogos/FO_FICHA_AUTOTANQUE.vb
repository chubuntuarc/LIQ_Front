...
#Region "SUB_PM_INIT"
    ...
    Public Sub PM_CB_INIT()
        ...
        Codigo_CB.PG_CB_VALUE_LOAD(CB_LI_TIPO_PUNTO_VENTA, 1)
        ...
        Codigo_CB.PG_CB_VALUE_LOAD(CB_TIPO_PUNTO_VENTA, 1)
    ...
    Public Sub PM_LI_INIT()
        ...
        Dim VM_CAMPOS As New ArrayList From {"K_PUNTO_VENTA", "D_UNIDAD_OPERATIVA", "D_PUNTO_VENTA", "S_ESTATUS_PUNTO_VENTA", "OPERADOR_NOMBRE", "CAPACIDAD", "PORCENTAJE", "LECTURA_INICIAL", "LECTURA_FINAL", "SERIE", "MATRICULA", "D_MARCA", "MODELO", "KILOMETRAJE"}
        Dim VM_TITULOS As New ArrayList From {"PDV", "Unidad operativa", "Descripción", "Estatus", "Operador", "Capacidad", "Porcentaje", "Lectura inicial", "Lectura final", "No. Serie", "Matricula", "Marca", "Modelo", "Kilometraje"}
        '///  K--ID | D--DESCRIPCION | S--SIGLAS | ESTATUS | GENERAL | CENTRADO | LECTURA | SERIE
        Dim VM_TIPOS As New ArrayList From {"K", "D", "D", "ESTATUS", "GENERAL", "DECIMAL LARGO", "PORCENTAJE", "LECTURA", "LECTURA", "SERIE", "CENTRADO", "CENTRADO LARGO", "CENTRADO", "DECIMAL LARGO"}
