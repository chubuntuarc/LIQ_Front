...
#Region "SUB_PM_INIT"
    ...
    Public Sub PM_CB_INIT()
        ...
        CB_LI_TIPO_PUNTO_VENTA.SelectedIndex = 3
    ...
    Public Sub PM_LI_INIT()
        ...
        Dim VM_CAMPOS As New ArrayList From {"K_PUNTO_VENTA", "D_PUNTO_VENTA", "S_ESTATUS_PUNTO_VENTA", "OPERADOR_NOMBRE", "D_UNIDAD_OPERATIVA", "D_MARCA_PORTATIL", "MATRICULA_PORTATIL", "MODELO_PORTATIL", "KILOMETRAJE_PORTATIL", "SERIE_PORTATIL", "CAPACIDAD_PORTATIL"}
        Dim VM_TITULOS As New ArrayList From {"PDV", "Descripción", "Estatus", "Operador", "Unidad operativa", "Marca", "Matricula", "Modelo", "Kilometraje", "Serie", "Capacidad"}
        '///  K--ID | D--DESCRIPCION | S--SIGLAS | ESTATUS | GENERAL | CENTRADO | LECTURA | SERIE
        Dim VM_TIPOS As New ArrayList From {"K", "D", "ESTATUS", "GENERAL", "GENERAL", "CENTRADO", "CENTRADO", "CENTRADO", "DECIMAL LARGO", "CENTRADO LARGO", "CENTRADO"}
