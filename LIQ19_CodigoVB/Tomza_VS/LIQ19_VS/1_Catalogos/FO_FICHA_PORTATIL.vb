Public Class FO_FICHA_PORTATIL
...
#Region "FUNCIONES_FM"
    ...
    Public Function FM_FI_SQL(ByRef PP_NUEVO As Boolean)
        ...
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_MARCA, False)
    ...
    Public Function FM_SAVE_VALIDATE(ByRef PP_MENSAJE_VALIDACION As String) As Boolean
        ...
        Codigo_CTRL.PG_TB_NUMERIC_VALIDATE(PP_MENSAJE_VALIDACION, TB_KILOMETRAJE)
        Codigo_CTRL.PG_TB_NUMERIC_VALIDATE(PP_MENSAJE_VALIDACION, TB_CAPACIDAD)
...
#Region "SUB_PM_INIT"
    ...
    Public Sub PM_CB_INIT()
        ...
        Codigo_CB.PG_CB_VALUE_LOAD(CB_LI_TIPO_PUNTO_VENTA, 3)
        ...
        Codigo_CB.PG_CB_VALUE_LOAD(CB_TIPO_PUNTO_VENTA, 3)
        ...
        Codigo_CB.PG_CB_LOAD_X_ORDEN(VM_ID_BASE_DE_DATOS, Me, CB_MARCA, "MARCA_UNIDAD")
    ...
    Public Sub PM_LI_INIT()
        ...
        Dim VP_PARAMETROS_DETALLE As String = "'',-1,3,-1"
        ...
        Dim VM_CAMPOS As New ArrayList From {"K_PUNTO_VENTA", "D_UNIDAD_OPERATIVA", "D_PUNTO_VENTA", "S_ESTATUS_PUNTO_VENTA", "OPERADOR_NOMBRE", "D_MARCA_PORTATIL", "MATRICULA_PORTATIL", "MODELO_PORTATIL", "KILOMETRAJE_PORTATIL", "SERIE_PORTATIL", "CAPACIDAD_PORTATIL"}
        Dim VM_TITULOS As New ArrayList From {"PDV", "Unidad operativa", "Descripción", "Estatus", "Operador", "Marca", "Matricula", "Modelo", "Kilometraje", "Serie", "Capacidad"}
        '///  K--ID | D--DESCRIPCION | S--SIGLAS | ESTATUS | GENERAL | CENTRADO | LECTURA | SERIE
        Dim VM_TIPOS As New ArrayList From {"K", "D", "D", "ESTATUS", "GENERAL", "CENTRADO", "CENTRADO", "CENTRADO", "DECIMAL LARGO", "CENTRADO LARGO", "CENTRADO"}

        LIQ19_Codigo.NUEVO_LISTADO(VP_DATATABLE, LI_LISTADO, VM_CAMPOS, VM_TITULOS, VM_TIPOS)
    End Sub

    Public Sub PM_TB_INIT()
        LIQ19_Codigo.PG_TB_INIT(TB_MATRICULA, 3)
        LIQ19_Codigo.PG_TB_INIT(TB_MODELO, 1)
        LIQ19_Codigo.PG_TB_INIT(TB_KILOMETRAJE, 2)
        LIQ19_Codigo.PG_TB_INIT(TB_SERIE, 3)
...
#Region "SUBS_PM"
    ...
    Public Sub PM_FI_LOAD(ByVal PP_ID As String)
        ...
        If PP_ID <> "" Then
            ...
            VP_RESULTADO_AUTOTANQUE = Codigo_SQL.FG_SP_EXECUTE_DATATABLE(VM_ID_BASE_DE_DATOS, "PG_SK_FICHA_PORTATIL", VP_PARAMETROS)
            ...
            If VP_RESULTADO_AUTOTANQUE.Rows.Count <> 0 Then
                ...
                Codigo_CB.PG_CB_VALUE_LOAD(CB_MARCA, Integer.Parse(VP_ROW_AUT("K_MARCA")))
    ...
    Public Sub PM_LI_ROW_WRITE(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW_DATA As DataRow)
        ...
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "D_MARCA_PORTATIL")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "MATRICULA_PORTATIL")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "MODELO_PORTATIL")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "KILOMETRAJE_PORTATIL")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "SERIE_PORTATIL")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "CAPACIDAD_PORTATIL")
