...
Public Class Conexion
    ...
    Public Shared Cadena_conexion As String = "Data Source=" + Constantes_Sistema.CG_SQL_SERVIDOR + ";Initial Catalog=" + Constantes_Sistema.CG_SQL_BASE_DATOS + "; Persist Security Info=True;User ID=" + Constantes_Sistema.CG_SQL_USUARIO + ";Password=" + Constantes_Sistema.CG_SQL_PASSWORD
