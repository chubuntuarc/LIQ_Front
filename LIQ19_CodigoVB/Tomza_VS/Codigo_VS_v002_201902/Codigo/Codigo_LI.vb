...
#Region "SUBS_LI"
    ...
    Public Shared Sub PG_LI_RESET(ByVal PP_BD_Index As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView, ByVal PP_EXITO As Boolean)
        If PP_EXITO Then
    ...
    Public Shared Sub PG_LI_DOUBLE_CLICK(ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        ...
        Try
            If PP_LISTADO.Rows.Count > 0 Then
                ...
                PP_FORMA.VM_IN_MODO_OPERACION = MOP_Modo_Operacion.MOP2_Ficha
                Codigo_FRM.PG_FRM_CONFIG(PP_FORMA)
            End If

        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_DOUBLE_CLICK")
        End Try
    End Sub
...
#Region "SUB_ROWS"
    ...
    Public Shared Sub PG_LI_ROW_COLOR_CHANGE(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW As Integer, ByVal PP_COLOR As Color)
        ...
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_COLOR_CHANGE")
        End Try
    ...
    Public Shared Sub PG_LI_ROW_VISIBLE(ByRef PP_LISTADO As DataGridView, ByVal VP_COL As String, ByRef PP_ROW As Integer)
        Try
            ...
            End If
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_ROW_VISIBLE")
        End Try
    ...
    Public Shared Sub PG_LI_ROW_EDIT(ByRef PP_LISTADO As DataGridView, ByVal VP_COL As String, ByRef PP_ROW As Integer)
        Try
            ...
            End If
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_ROW_EDIT")
        End Try
    ...
    Public Shared Sub PG_LI_ROW_PAINT(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW As Integer, ByVal PP_COLOR As Color)
        Try
            PP_LISTADO.Rows(PP_ROW).DefaultCellStyle.BackColor = PP_COLOR
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_ROW_PAINT")
        End Try
...
#Region "SUB_CELLS"
    ...
    Public Shared Sub PG_LI_CELL_MOD_WRITE(ByRef PP_LISTADO As DataGridView, ByVal VP_ROW As Integer, ByVal VP_COL As Integer)
        ...
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_CELL_MOD_WRITE")
        End Try
    ...
    Public Shared Function FG_LI_CELL_GET_COLUMN_NAME(ByRef PP_LISTADO As DataGridView) As String
        ...
        Catch ex As ArgumentException
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("FG_LI_CELL_GET_COLUMN")
        End Try
        Return COL_NAME
    End Function
    ...
    Public Shared Sub PG_LI_CELL_FONT_PROPERTIES(ByRef PP_ROW As DataGridViewRow, ByVal PP_COLUMNA As String)
        ...
        Try
            ...
            End Select
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_CELL_FONT_PROPERTIES")
        End Try
    End Sub
    ...
    Public Shared Sub PG_LI_CELL_FONT_PROPERTIES_RUNTIME(ByRef PP_ROW As DataGridViewRow, ByVal PP_COLUMNA As String, ByVal PP_NIVEL As Integer, ByVal PP_TIPO_FORMATO As String) ' PP_TIPO_FORMATO [1:PRESUPUESTO(PPO) / 2=PÓLIZA FLUJO DIARIO(PFD)]
        ...
        Try
            ...
            End Select
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_CELL_FONT_PROPERTIES_RUNTIME")
        End Try
    End Sub
    ...
    Public Shared Sub PG_LI_CELL_WRITE(ByRef PP_LISTADO As DataGridView, ByVal PP_ROW As Integer, ByVal PP_COLUMN As Integer, ByVal PP_ROW_DATA As DataRow, ByVal PP_NOMBRE_DATO As String, Optional PP_DEFAULT As String = "")
        ...
        REM // WIWI //  VALIDA CAMPO QUE NO EXISTA
        Try

            If Codigo_SQL.FG_DataRow_IsDBNull(PP_ROW_DATA, PP_NOMBRE_DATO) Then
        ...
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_CELL_WRITE @=[" + PP_NOMBRE_DATO + "]")
        End Try
    ...
    Public Shared Sub PG_LI_CELL_MOD_COLOR(ByRef PP_LISTADO As DataGridView, ByVal VP_ROW As Integer, ByVal VP_COL As Integer)
        ...
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_MOD_COLOR")
        End Try
    End Sub
    ...
    Public Shared Sub PG_LI_CELL_ZERO_FILL(ByRef PP_LISTADO As DataGridView, ByVal VP_ROW As Integer)
        ...
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_CELL_ZERO_FILL")
        End Try
    ...
    Public Shared Sub PG_LI_CELL_COLOR_CHANGE(ByRef PP_LISTADO As DataGridView, ByVal VP_ROW As Integer, ByVal VP_COL As Integer, ByVal VP_COLOR As Color)
        ...
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_CELL_COLOR_CHANGE")
        End Try
    End Sub
#End Region
...
#Region "SUB_COLUMNS"
    ...
    Public Shared Sub PG_LI_COLUMN_ADD_K_Listado(ByRef PP_LISTADO As DataGridView, ByVal Nom_col As String, ByVal Head_Txt As String)
    ...
    Public Shared Sub PG_LI_COLUMN_ADD_S_Estatus(ByRef PP_LISTADO As DataGridView, ByVal Nom_col As String, ByVal Head_Txt As String)
        'PARAMETROS: NOMBRE_DATAGRIDVIEW, NOMBRE_COLUMNA, HEADER_TEXT, TIPO_DATO, ANCHO_CELDA, ALINEACION[1.Izq, 2.Cen, 3.Der], 
        '            SOLO_LECTURA[0, 1], VISIBLE[0, 1], FROZEN[0, 1], FORMATO MONEDA[0, (1, 2)],PP_COLOR_FONT [1=RED], PP_COLOR_BACKGROUND [1=RED],
        '            PP_BOLD[0,1] 

        Call PG_LI_COLUMN_ADD(PP_LISTADO, Nom_col, Head_Txt, GetType(String), 70, 2, 0, 1, 0, 0, Color.DarkSlateGray, Color.Gainsboro, 1)

    End Sub

    Public Shared Sub PG_LI_COLUMN_ADD_F_mes(ByRef PP_LISTADO As DataGridView, ByVal Nom_col As String, ByVal Head_Txt As String)
        'PARAMETROS: NOMBRE_DATAGRIDVIEW, NOMBRE_COLUMNA, HEADER_TEXT, TIPO_DATO, ANCHO_CELDA, ALINEACION[1.Izq, 2.Cen, 3.Der], 
        '            SOLO_LECTURA[0, 1], VISIBLE[0, 1], FROZEN[0, 1], FORMATO MONEDA[0, (1, 2)],PP_COLOR_FONT [1=RED], PP_COLOR_BACKGROUND [1=RED],
        '            PP_BOLD[0,1] 

        Call PG_LI_COLUMN_ADD(PP_LISTADO, Nom_col, Head_Txt, GetType(String), 45, 2, 0, 1, 1, 0)

    End Sub

    Public Shared Sub PG_LI_COLUMN_ADD_F_yyyy(ByRef PP_LISTADO As DataGridView, ByVal Nom_col As String, ByVal Head_Txt As String)
        'PARAMETROS: NOMBRE_DATAGRIDVIEW, NOMBRE_COLUMNA, HEADER_TEXT, TIPO_DATO, ANCHO_CELDA, ALINEACION[1.Izq, 2.Cen, 3.Der], 
        '            SOLO_LECTURA[0, 1], VISIBLE[0, 1], FROZEN[0, 1], FORMATO MONEDA[0, (1, 2)],PP_COLOR_FONT [1=RED], PP_COLOR_BACKGROUND [1=RED],
        '            PP_BOLD[0,1] 
    ...
    Public Shared Sub PG_LI_COLUMN_ADD_Monto(ByRef PP_LISTADO As DataGridView, ByVal Nom_col As String, ByVal Head_Txt As String)
        'PARAMETROS: NOMBRE_DATAGRIDVIEW, NOMBRE_COLUMNA, HEADER_TEXT, TIPO_DATO, ANCHO_CELDA, ALINEACION[1.Izq, 2.Cen, 3.Der], 
        '            SOLO_LECTURA[0, 1], VISIBLE[0, 1], FROZEN[0, 1], FORMATO MONEDA[0, (1, 2)],PP_COLOR_FONT [1=RED], PP_COLOR_BACKGROUND [1=RED],
        '            PP_BOLD[0,1] 

        Call PG_LI_COLUMN_ADD(PP_LISTADO, Nom_col, (Head_Txt + " ($)"), GetType(Decimal), 90, 3, 0, 1, 0, 1, Nothing, Color.LightYellow, 0)

    End Sub

    Public Shared Sub PG_LI_COLUMN_ADD_Precio(ByRef PP_LISTADO As DataGridView, ByVal Nom_col As String, ByVal Head_Txt As String)
        'PARAMETROS: NOMBRE_DATAGRIDVIEW, NOMBRE_COLUMNA, HEADER_TEXT, TIPO_DATO, ANCHO_CELDA, ALINEACION[1.Izq, 2.Cen, 3.Der], 
        '            SOLO_LECTURA[0, 1], VISIBLE[0, 1], FROZEN[0, 1], FORMATO MONEDA[0, (1, 2)],PP_COLOR_FONT [1=RED], PP_COLOR_BACKGROUND [1=RED],
        '            PP_BOLD[0,1] 

        Call PG_LI_COLUMN_ADD(PP_LISTADO, Nom_col, (Head_Txt + " ($)"), GetType(Decimal), 60, 3, 0, 1, 0, 1, Nothing, Color.LightYellow, 0)

    End Sub

    Public Shared Sub PG_LI_COLUMN_ADD_Porcentaje(ByRef PP_LISTADO As DataGridView, ByVal Nom_col As String, ByVal Head_Txt As String)
        'PARAMETROS: NOMBRE_DATAGRIDVIEW, NOMBRE_COLUMNA, HEADER_TEXT, TIPO_DATO, ANCHO_CELDA, ALINEACION[1.Izq, 2.Cen, 3.Der], 
        '            SOLO_LECTURA[0, 1], VISIBLE[0, 1], FROZEN[0, 1], FORMATO MONEDA[0, (1, 2)],PP_COLOR_FONT [1=RED], PP_COLOR_BACKGROUND [1=RED],
        '            PP_BOLD[0,1] 

        Call PG_LI_COLUMN_ADD(PP_LISTADO, Nom_col, (Head_Txt + " (%)"), GetType(Decimal), 70, 2, 0, 1, 0, 0, Nothing, Color.LightYellow, 0)

    End Sub

    Public Shared Sub PG_LI_COLUMN_ADD_F_ddmmmyyyy(ByRef PP_LISTADO As DataGridView, ByVal Nom_col As String, ByVal Head_Txt As String)
        'PARAMETROS: NOMBRE_DATAGRIDVIEW, NOMBRE_COLUMNA, HEADER_TEXT, TIPO_DATO, ANCHO_CELDA, ALINEACION[1.Izq, 2.Cen, 3.Der], 
        '            SOLO_LECTURA[0, 1], VISIBLE[0, 1], FROZEN[0, 1], FORMATO MONEDA[0, (1, 2)],PP_COLOR_FONT [1=RED], PP_COLOR_BACKGROUND [1=RED],
        '            PP_BOLD[0,1] 

        Call PG_LI_COLUMN_ADD(PP_LISTADO, Nom_col, Head_Txt, GetType(DateTime), 80, 2, 0, 1, 0, 0)
    ...
    Public Shared Sub PG_LI_COLUMN_ADD(ByRef PP_LISTADO As DataGridView, ByVal Nom_col As String, ByVal Head_Txt As String,
        ...
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_COLUMN_ADD")
        End Try
    End Sub
    ...
    Public Shared Sub PG_LI_COLUMN_ADD_CHECK(ByRef PP_LISTADO As DataGridView, ByVal Nom_col As String, ByVal Head_Txt As String,
        ...
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_COLUMN_ADD_CHECK")
        End Try
    End Sub
    ...
    Public Shared Sub PG_LI_COLUMN_FONT_COLOR_CHANGE(ByRef PP_LISTADO As DataGridView, ByVal PP_NOM_COL As String, ByVal PP_COLOR As Color)
        ...
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_COLUMN_FONT_COLOR_CHANGE")
        End Try
    ...
    Public Shared Sub PG_LI_COLUMN_COLOR_CHANGE(ByRef PP_LISTADO As DataGridView, ByVal VP_NOM_COL As String, ByVal VP_COLOR As Color)
        ...
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_COLUMN_COLOR_CHANGE")
        End Try
    ...
    Public Shared Sub PG_LI_COLUMN_HEAD_CHANGE(ByRef PP_LISTADO As DataGridView, ByVal VP_NOM_COL As String, ByVal VP_TITULO As String)
        ...
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("PG_LI_COLUMN_HEAD_CHANGE")
        End Try
...
#Region "FUNCIONES"
    Public Shared Function FG_LI_CELL_READ(ByVal PP_LISTADO As DataGridView, ByVal PP_ROW As Integer, ByVal PP_COLUMNA As String) As String
        ...
        Catch ex As Exception
            'Codigo_Mensaje.PG_MENSAJE_ERROR_VS("FG_LI_CELL_READ")
        End Try
        Return VP_ID
    End Function
    ...
    Public Shared Function FG_LI_CELL_READ_RUNTIME(ByVal PP_DATAROW As DataRow, ByVal PP_COLUMNA As String) As String
        ...
        Catch ex As Exception
            'Codigo_Mensaje.PG_MENSAJE_ERROR_VS("FG_LI_CELL_READ_RUNTIME")
        End Try
        Return VP_VALUE
    End Function
    ...
    Public Shared Function FG_LI_CELL_VALUE(ByRef PP_LI_LISTADO As DataGridView, ByVal INDR As Integer, ByVal INDC As String)
        ...
        Catch ex As Exception
            'Codigo_Mensaje.PG_MENSAJE_ERROR_VS("FG_LI_CELL_VALUE")
        End Try
        Return VP_VALOR
    End Function
    ...
    Public Shared Function FG_LI_ROW_CURRENT(ByVal PP_LISTADO As DataGridView) As Integer
        ...
        Try
            ...
            End If
        Catch ex As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("FG_LI_ROW_CURRENT")
        End Try
        Return VP_ROW
    End Function
    ...
    Public Shared Function FG_LI_ROW_INDEX(ByVal PP_LISTADO As DataGridView, ByVal PP_VALUE As String, ByVal PP_COLUMNA As String) As Integer
        Try
            If PP_LISTADO.Rows.Count > 0 Then
                ...
                Next
            Else
                Codigo_Mensaje.PG_MENSAJE_AVISO("El <Listado> se encuentra vacio, verifique.")
                Return -1
            End If
        Catch ex As Exception
            Return -1
        ...
        Try
            If PP_LISTADO.Rows.Count > 0 Then
                If PP_LISTADO.CurrentCell Is Nothing Then
                    Codigo_Mensaje.PG_MENSAJE_AVISO("Favor de <Seleccionar> un registro.")
                    Return False
                Else
                    Return True
                End If
