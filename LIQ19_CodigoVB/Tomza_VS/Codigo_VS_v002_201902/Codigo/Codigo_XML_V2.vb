...
Public Class Codigo_XML_V2
    ...
    Public Shared Function PG_OBTENER_ATRIBUTOS(ByVal PP_BD_Index As Integer, ByRef PP_FORMA As Object,
    ...
    Public Shared Sub PG_VERIFICAR_VALORES(ByVal PP_FORMA As Object)
        ...
        Else
            Try
                ...
                Next
            Catch ex As Exception
                Codigo_Mensaje.PG_MENSAJE_AVISO("[ERROR]   //   Archivo Ilegible, Código de Error: " + vbCrLf + ex.Message + vbCrLf + "Intente con otro Archivo.")
            End Try
        End If
    ...
    Public Shared Function FG_XML_GET_VALOR(ByVal PP_XML_NODOS As XmlDocument, ByVal PP_TAGNAME As String,
        ...
        Catch VP_E As Exception
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("FG_XML_GET_VALOR")
        End Try
        Return VP_VALOR
    End Function

    'Este procedimiento es para Insertar los XML en la tabla //   AXR
    Public Shared Function FG_INSERTAR_FACTURA_XML(ByVal PP_BD_Index As Integer, ByRef PP_FORMA As Object,
