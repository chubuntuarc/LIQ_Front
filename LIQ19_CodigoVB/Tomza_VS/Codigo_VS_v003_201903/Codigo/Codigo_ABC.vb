...
#Region "EVENTOS_BOTONES"
    ...
    '    VP_TABLA = Codigo_CON.FG_SP_EXECUTE_DATATABLE(PP_FORMA.VM_BD_Index, VP_STORED_PROCEDURE, VP_PARAMETROS)
...
#Region "FUNCIONES"
    ...
    Public Shared Function FG_DT_CONVIERTE_FECHA_MX_A_US(ByVal PP_FECHA As Date) As String ' Recibe una fecha en formato dd/mm/yyyy
        Dim VP_FECHA_MOSTRAR As String = ""
        Try
            VP_FECHA_MOSTRAR = PP_FECHA.ToString("MM/dd/yyyy") ' Regresa una fecha en formato mm/dd/yyyy
        Catch ex As ArgumentException
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("FG_DT_CONVIERTE_FECHA_MX_A_US")
        End Try

        Return VP_FECHA_MOSTRAR
    End Function
    ...
    Public Shared Function FG_DT_CONVIERTE_FECHA_US_A_MX(ByVal PP_FECHA As Date) As String ' Recibe una fecha en formato mm/dd/yyyy
        Dim VP_FECHA_MOSTRAR As String = ""
        Try
            VP_FECHA_MOSTRAR = PP_FECHA.ToString("dd/MM/yyyy") ' Regresa una fecha en formato dd/mm/yyyy
        Catch ex As ArgumentException
    ...
    Public Shared Function FG_DT_AGREGA_CEROS_FECHA_US(ByVal PP_FECHA As Date) As String ' Recibe una fecha en formato mm/dd/yyyy
        Dim VP_FECHA_MOSTRAR As String = ""
        Try
            VP_FECHA_MOSTRAR = PP_FECHA.ToString("MM/dd/yyyy") ' Regresa una fecha en formato mm/dd/yyyy con los ceros para los meses o días menores a 10
        Catch ex As ArgumentException
    ...
    Public Shared Function FG_DT_CONVIERTE_FECHA_US_A_SQL(ByVal PP_FECHA As Date) As String ' Recibe una fecha en formato mm/dd/yyyy
        Dim VP_FECHA_MOSTRAR As String = ""
        Try
            VP_FECHA_MOSTRAR = PP_FECHA.ToString("yyyy-MM-dd") ' Regresa una fecha en formato yyyy-mm-dd
        Catch ex As ArgumentException
    ...
    Public Shared Function FG_DT_CONVIERTE_FECHA_XML_A_SQL(ByVal PP_FECHA As String) As String ' Recibe una fecha en formato mm/dd/yyyy
        Dim VP_FECHA_MOSTRAR As String = ""
        Try
            VP_FECHA_MOSTRAR = PP_FECHA.Substring(0, 10) ' Regresa una fecha en formato yyyy-mm-dd
        Catch ex As ArgumentException
    ...
    Public Shared Function FG_DT_CONVIERTE_FECHA_A_SQL(ByVal PP_FECHA As String) As String ' Recibe una fecha en formato dd/MM/yyyy
        ...
        Try
            Select Case VG_CULTURE_INFO
                Case 0
                    VP_FECHA_MOSTRAR = Convert.ToDateTime(PP_FECHA).ToString("MM-dd-yyyy") ' Regresa una fecha en formato yyyy-mm-dd
                Case 5
                    VP_FECHA_MOSTRAR = Convert.ToDateTime(PP_FECHA).ToString("dd-MM-yyyy") ' Regresa una fecha en formato yyyy-mm-dd
            End Select
        Catch ex As ArgumentException
            Codigo_Mensaje.PG_MENSAJE_ERROR_VS("")
        End Try
