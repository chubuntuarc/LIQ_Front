Public Class Codigo_FI
    ...
    Public Shared Sub FG_FI_LOAD_X_ID(ByVal PP_BD_Index As Integer, ByRef PP_FORMA As Object, ByVal PP_ID As String)
        On Error Resume Next
        Dim VP_ROW As DataRow = Nothing
        PG_FI_CONTROL_CLEAR(PP_FORMA.GB_FICHA)
        VP_ROW = Codigo_ABC.FG_DC_ID_SEARCH(PP_BD_Index, PP_FORMA, PP_ID)
    ...
    Public Shared Sub FG_FI_LOAD_X_ID(ByVal PP_BD_Index As Integer, ByRef PP_FORMA As Object, ByRef PP_FICHA As GroupBox, ByVal PP_ID As String)
    ...
    Public Shared Sub PG_FI_CONTROL_DATA_SETUP(ByVal PP_BD_Index As Integer, ByRef PP_FORMA As Object)
        On Error Resume Next
        'wiwi
        Codigo_CB.PG_CB_LOAD_X_ORDEN(PP_BD_Index, PP_FORMA, PP_FORMA.CB_ESTATUS_ACTIVO, "ESTATUS_ACTIVO")
        Codigo_CB.PG_CB_LOAD_X_ORDEN(PP_BD_Index, PP_FORMA, PP_FORMA.CB_USUARIO_ALTA, "USUARIO")
        Codigo_CB.PG_CB_LOAD_X_ORDEN(PP_BD_Index, PP_FORMA, PP_FORMA.CB_USUARIO_CAMBIO, "USUARIO")
    ...
    Public Shared Sub PG_CN_CONFIG(ByRef PP_FORMA As Object)
        PP_FORMA.GB_FICHA.Enabled = (PP_FORMA.VM_IN_MODO_OPERACION = MOP_Modo_Operacion.MOP3_Edicion Or PP_FORMA.VM_IN_MODO_OPERACION = MOP_Modo_Operacion.MOP4_Clon)
    End Sub
