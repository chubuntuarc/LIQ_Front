...
#Region "VARIABLES LOCALES"
    ...
    Dim VP_PRINTER As Printer = New Printer

    Public Property VP_PRINTER1 As Printer
        Get
            Return VP_PRINTER
        End Get
...
#Region "CONFIGURACIÓN"
    ...
    Public Sub PG_FUENTE_BASE()
        ...
        'VP_PRINTER.FontSize = VP_TAMANO_FUENTE
        VP_PRINTER1.ScaleWidth = 2159
        VP_PRINTER1.ScaleHeight = 2790
        VP_PRINTER1.FontName = "Courier New"
    End Sub
...
#Region "SUBS_PM ESCALAS"
    ...
    Public Sub PG_RECTANGULO_CM(ByRef PP_Xcm As Decimal, ByRef PP_Ycm As Decimal, ByRef PP_ANcm As Decimal, ByRef PP_ALcm As Decimal)
        ...
        Try
            ...
            VP_PRINTER1.Line(VP_X1, VP_Y1, VP_X2, VP_Y2, 1, True, False)
    ...
    Public Sub PG_TEXTO_CM(ByRef PP_Ncol As Decimal, ByRef PP_Nrow As Decimal, ByRef PP_Texto As String)
        ...
        Try
            ...
            VP_PRINTER1.CurrentX = VP_X1 : VP_PRINTER1.CurrentY = VP_Y1
            VP_PRINTER1.Print(PP_Texto)
        Catch ex As Exception
