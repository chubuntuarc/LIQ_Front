...
Public Class TabControlEx
    ...
    <Browsable(True), DefaultValue(True), Category("Behavior"), Description("Indica cuando se debe mostrar el botón de cerrar en cada TabPage")>
    ...
    Protected Overrides Sub OnControlAdded(ByVal e As System.Windows.Forms.ControlEventArgs)
        ...
        Dim VP_TAG As String
        VP_TAG = tp.Tag.ToString()
        Dim btn As Button = AddCloseButton(tp, VP_TAG)
    ...
    Protected Overridable Function AddCloseButton(ByVal tp As TabPage, ByVal VP_ES_MENU As String) As Button
