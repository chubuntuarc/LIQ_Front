...
#Region "SUB_PM_INIT"
    ...
    Public Sub PM_CB_INIT()
        ...
        CB_LI_ESTATUS_PUNTO_VENTA.SelectedIndex = 1
...
#Region "SUBS_PM"
    ...
    Private Sub PM_LI_FORMAT(ByRef PP_LI_LISTADO As DataGridView)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "S_TIPO_PUNTO_VENTA", "Tipo", GetType(String), 60, 2, 0, 1, 0, 0, Color.Orange, Nothing, 1)
