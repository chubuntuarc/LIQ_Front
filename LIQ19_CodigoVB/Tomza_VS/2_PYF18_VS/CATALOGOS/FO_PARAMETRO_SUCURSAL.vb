...
Public Class FO_PARAMETRO_SUCURSAL
...
#Region "FUNCIONES_FM"
    ...
    Public Function FM_SQL_LISTADO() As String
        ...
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_LI_ESTATUS_PARAMETRO_SUCURSAL, False)
    ...
    Public Function FM_FI_SQL(ByRef PP_NUEVO As Boolean)
        Dim VP_PARAMETROS = ""
        PP_NUEVO = True
        If TB_K_PARAMETRO_SUCURSAL.Text <> "" Then
            Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, TB_K_PARAMETRO_SUCURSAL, False)
            PP_NUEVO = False
        End If
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, TB_D_PARAMETRO_SUCURSAL, True)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_UNIDAD_OPERATIVA, False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_ESTATUS_PARAMETRO_SUCURSAL, False)
    ...
    Public Function FM_DESC_SELECCIONADO(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW As Integer) As String
        Dim VP_ID As String = ""
        VP_ID = Codigo_LI.FG_LI_CELL_READ(PP_LISTADO, PP_ROW, "D_PARAMETRO_SUCURSAL")
        Return VP_ID
    End Function

    Public Function FM_ID_SELECCIONADO(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW As Integer) As String
        Dim VP_ID As String = ""
        VP_ID = Codigo_LI.FG_LI_CELL_READ(PP_LISTADO, PP_ROW, "K_PARAMETRO_SUCURSAL")
        Return VP_ID
    End Function
    ...
    Public Function FM_LI_SQL_SAVE(ByVal PP_LI_LISTADO As DataGridView, ByVal PP_INDR As Integer) As String
        ...
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_LI_LISTADO.Rows(PP_INDR).Cells("K_PARAMETRO_SUCURSAL"), False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_LI_LISTADO.Rows(PP_INDR).Cells("D_PARAMETRO_SUCURSAL"), True)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_LI_LISTADO.Rows(PP_INDR).Cells("K_UNIDAD_OPERATIVA"), False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_LI_LISTADO.Rows(PP_INDR).Cells("K_ESTATUS_PARAMETRO_SUCURSAL"), False)
        ...
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_LI_LISTADO.Rows(PP_INDR).Cells("DESCUENTO_CREDITO_0_100"), False)
        ...
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, PP_LI_LISTADO.Rows(PP_INDR).Cells("VENTA_PORCENTAJE_CREDITO_0_100"), False)
...
#Region "SUB_PM_INIT"
    ...
    Public Sub PM_CB_INIT()
        ...
        Codigo_CB.PG_CB_UNIDAD_OPERATIVA_Load(VM_ID_BASE_DE_DATOS, Me, CB_UNIDAD_OPERATIVA, 0, 0, CB_LI_ZONA_UO, New ComboBox, VG_USUARIO_ACCION)
        ...
        Codigo_CB.PG_CB_LOAD_X_ORDEN(VM_ID_BASE_DE_DATOS,Me, CB_ESTATUS_PARAMETRO_SUCURSAL)
        Codigo_CB.PG_CB_LOAD_X_ORDEN(VM_ID_BASE_DE_DATOS,Me, CB_LI_ESTATUS_PARAMETRO_SUCURSAL)

    End Sub

    Public Sub PM_TB_INIT()
        Codigo_CTRL.PG_TB_INIT(TB_COBRANZA_HOLGURA, 1)
        Codigo_CTRL.PG_TB_INIT(TB_DESCUENTO_CONTADO, 1)
        Codigo_CTRL.PG_TB_INIT(TB_DESCUENTO_CREDITO, 1)
        Codigo_CTRL.PG_TB_INIT(TB_P1003_VENTA_KG_CONTADO, 1)
        Codigo_CTRL.PG_TB_INIT(TB_P1004_VENTA_KG_CREDITO, 1)
        Codigo_CTRL.PG_TB_INIT(TB_P1012_CARTERA_CYC_INICIAL, 1)
        Codigo_CTRL.PG_TB_INIT(TB_P1013_CARTERA_CYC_FINAL, 1)
        Codigo_CTRL.PG_TB_INIT(TB_P2016_DTO_DESCUENTO_X_KG, 1)
        Codigo_CTRL.PG_TB_INIT(TB_P2023_PCN, 1)

        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_COBRANZA_1_LUNES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_COBRANZA_2_MARTES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_COBRANZA_3_MIERCOLES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_COBRANZA_4_JUEVES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_COBRANZA_5_VIERNES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_COBRANZA_6_SABADO, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_COBRANZA_7_DOMINGO, 1)

        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CONTADO_1_LUNES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CONTADO_2_MARTES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CONTADO_3_MIERCOLES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CONTADO_4_JUEVES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CONTADO_5_VIERNES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CONTADO_6_SABADO, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CONTADO_7_DOMINGO, 1)

        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CREDITO_1_LUNES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CREDITO_2_MARTES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CREDITO_3_MIERCOLES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CREDITO_4_JUEVES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CREDITO_5_VIERNES, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CREDITO_6_SABADO, 1)
        Codigo_CTRL.PG_TB_INIT(TB_PERFIL_VENTA_CREDITO_7_DOMINGO, 1)
...
#Region "SUBS_PM"
    ...
    Public Sub PM_FI_CARGAR(ByVal PP_ROW As DataRow)
        If VM_IN_MODO_OPERACION <> Modo_Operacion.Clon Then
            Codigo_CTRL.PG_CO_DATA_LOAD("", TB_K_PARAMETRO_SUCURSAL, PP_ROW)
            Codigo_FI.PG_FI_CONTROL_DATA_LOAD(Me, PP_ROW)
        End If

        Codigo_CTRL.PG_CO_DATA_LOAD("", TB_D_PARAMETRO_SUCURSAL, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("", TB_P2016_DTO_DESCUENTO_X_KG, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("DESCUENTO_CREDITO_0_100", TB_DESCUENTO_CREDITO, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("DESCUENTO_CONTADO_0_100", TB_DESCUENTO_CONTADO, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("", TB_P2023_PCN, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("VENTA_PORCENTAJE_CONTADO_0_100", TB_P1003_VENTA_KG_CONTADO, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("VENTA_PORCENTAJE_CREDITO_0_100", TB_P1004_VENTA_KG_CREDITO, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("", TB_P2023_PCN, PP_ROW)
        ...
        Codigo_CTRL.PG_CO_DATA_LOAD("COBRANZA_HOLGURA_0_100", TB_COBRANZA_HOLGURA, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CONTADO_1_LUNES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CONTADO_2_MARTES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CONTADO_3_MIERCOLES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CONTADO_4_JUEVES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CONTADO_5_VIERNES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CONTADO_6_SABADO, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CONTADO_7_DOMINGO, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CREDITO_1_LUNES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CREDITO_2_MARTES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CREDITO_3_MIERCOLES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CREDITO_4_JUEVES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CREDITO_5_VIERNES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CREDITO_6_SABADO, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_VENTA_CREDITO_7_DOMINGO, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_COBRANZA_1_LUNES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_COBRANZA_2_MARTES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_COBRANZA_3_MIERCOLES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_COBRANZA_4_JUEVES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_COBRANZA_5_VIERNES, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_COBRANZA_6_SABADO, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD_CURRENCY("", TB_PERFIL_COBRANZA_7_DOMINGO, PP_ROW)
        ...
        Codigo_CTRL.PG_CO_DATA_LOAD("", CB_ESTATUS_PARAMETRO_SUCURSAL, PP_ROW)
        'Codigo_FI.PG_FI_CONTROL_DATA_LOAD(Me, PP_ROW)
    ...
    Private Sub PM_LI_FORMAT(ByRef PP_LI_LISTADO As DataGridView)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "K_PARAMETRO_SUCURSAL", "#PSU", GetType(Integer), 60, 1, 1, 1, 1, 0, Color.White, Color.Black, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D_PARAMETRO_SUCURSAL", "Descripción", GetType(Integer), 100, 1, 1, 1, 1, 0, Nothing, Nothing, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "K_UNIDAD_OPERATIVA", "ID UNIDAD OPERATIVA", GetType(String), 80, 1, 1, 0, 1, 0)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D_UNIDAD_OPERATIVA", "Unidad Operativa", GetType(String), 140, 1, 1, 1, 1, 0, Color.DarkOrange, Nothing, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "K_ESTATUS_PARAMETRO_SUCURSAL", "Estatus", GetType(Integer), 80, 2, 1, 0, 0, 0)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "S_ESTATUS_PARAMETRO_SUCURSAL", "Estatus", GetType(Integer), 80, 2, 1, 1, 0, 0, Color.DarkSlateGray, Color.Gainsboro, 1)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "DESCUENTO_CREDITO_0_100", "Descuento CRE %", GetType(Decimal), 80, 2, 1, 1, 0, 1, Nothing, Color.LightYellow)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "VENTA_PORCENTAJE_CREDITO_0_100", "Venta CRE %", GetType(Decimal), 80, 2, 1, 1, 0, 1, Nothing, Color.LightYellow)
        ...
        Dim VP_VENTA_CONTADO_VISIBLE As Integer = Convert.ToInt32(CH_VENTA_CONTADO.Checked)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_1_LUNES", "Venta CON/Lun", GetType(Decimal), 70, 2, 1, VP_VENTA_CONTADO_VISIBLE, 0, 1, Nothing, Color.LightCyan)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_2_MARTES", "Venta CON/Mar", GetType(Decimal), 70, 2, 1, VP_VENTA_CONTADO_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_3_MIERCOLES", "Venta CON/Mie", GetType(Decimal), 70, 2, 1, VP_VENTA_CONTADO_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_4_JUEVES", "Venta CON/Jue", GetType(Decimal), 70, 2, 1, VP_VENTA_CONTADO_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_5_VIERNES", "Venta CON/Vie", GetType(Decimal), 70, 2, 1, VP_VENTA_CONTADO_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_6_SABADO", "Venta CON/Sab", GetType(Decimal), 70, 2, 1, VP_VENTA_CONTADO_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CONTADO_7_DOMINGO", "Venta CON/Dom", GetType(Decimal), 70, 2, 1, VP_VENTA_CONTADO_VISIBLE, 0, 1)

        Dim VP_VENTA_CREDITO_VISIBLE As Integer = Convert.ToInt32(CH_VENTA_CREDITO.Checked)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_1_LUNES", "Venta CRE/Lun", GetType(Decimal), 70, 2, 1, VP_VENTA_CREDITO_VISIBLE, 0, 1, Nothing, Color.LightCyan)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_2_MARTES", "Venta CRE/Mar", GetType(Decimal), 70, 2, 1, VP_VENTA_CREDITO_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_3_MIERCOLES", "Venta CRE/Mie", GetType(Decimal), 70, 2, 1, VP_VENTA_CREDITO_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_4_JUEVES", "Venta CRE/Jue", GetType(Decimal), 70, 2, 1, VP_VENTA_CREDITO_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_5_VIERNES", "Venta CRE/Vie", GetType(Decimal), 70, 2, 1, VP_VENTA_CREDITO_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_6_SABADO", "Venta CRE/Sab", GetType(Decimal), 70, 2, 1, VP_VENTA_CREDITO_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_VENTA_CREDITO_7_DOMINGO", "Venta CRE/Dom", GetType(Decimal), 70, 2, 1, VP_VENTA_CREDITO_VISIBLE, 0, 1)

        Dim VP_COBRANZA_VISIBLE As Integer = Convert.ToInt32(CH_COBRANZA.Checked)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_1_LUNES", "Cobranza Lun", GetType(Decimal), 70, 2, 1, VP_COBRANZA_VISIBLE, 0, 1, Nothing, Color.LightCyan)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_2_MARTES", "Cobranza Mar", GetType(Decimal), 70, 2, 1, VP_COBRANZA_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_3_MIERCOLES", "Cobranza Mie", GetType(Decimal), 70, 2, 1, VP_COBRANZA_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_4_JUEVES", "Cobranza Jue", GetType(Decimal), 70, 2, 1, VP_COBRANZA_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_5_VIERNES", "Cobranza Vie", GetType(Decimal), 70, 2, 1, VP_COBRANZA_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_6_SABADO", "Cobranza Sab", GetType(Decimal), 70, 2, 1, VP_COBRANZA_VISIBLE, 0, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "PERFIL_COBRANZA_7_DOMINGO", "Cobranza Dom", GetType(Decimal), 70, 2, 1, VP_COBRANZA_VISIBLE, 0, 1)
    ...
    Public Sub PM_LI_ESCRIBE(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW_DATA As DataRow)
        Dim VP_COLUMNA As Integer = 0
        Dim VP_ROW As Integer
        VP_ROW = Codigo_LI.FG_LI_MAX_ROW(PP_LISTADO)
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "K_PARAMETRO_SUCURSAL")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "D_PARAMETRO_SUCURSAL")
        ...
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "K_ESTATUS_PARAMETRO_SUCURSAL")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "S_ESTATUS_PARAMETRO_SUCURSAL")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "P2016_DTO_DESCUENTO_X_KG")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL_PORCENTAJE(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "DESCUENTO_CONTADO_0_100")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL_PORCENTAJE(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "DESCUENTO_CREDITO_0_100")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "P2023_PCN")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL_PORCENTAJE(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "VENTA_PORCENTAJE_CONTADO_0_100")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL_PORCENTAJE(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "VENTA_PORCENTAJE_CREDITO_0_100")
        ...
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL_PORCENTAJE(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "COBRANZA_HOLGURA_0_100")
    ...
    Public Sub PM_LI_ROW_WRITE(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW_DATA As DataRow)
        ...
        Else
            ...
            For Each VP_ROW As DataGridViewRow In VM_DATAGRID.Rows
                ...
                If VP_ROW.Cells("K_PARAMETRO_SUCURSAL").Value = PP_ROW_DATA("K_PARAMETRO_SUCURSAL") Then
    ...
    Public Sub PM_BT_GUARDAR_CLICK(ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        If VM_IN_MODO_OPERACION = Modo_Operacion.Listado Then
            PM_LI_SAVE(VM_ID_BASE_DE_DATOS, PP_FORMA, PP_LISTADO)
    ...
    Public Sub PM_LI_SAVE(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        Dim VP_PARAMETROS As String = ""
        ...
        Try
            ...
            For Each VP_FILA In PP_LISTADO.Rows
                ...
                If VP_DATO = 1 Then
                    ...
                    VP_NUEVO_ROW(1) = IIf(VP_MENSAJE = "", "SI", "NO")
            ...
            If VP_INDICES.Count > 0 Then
                For Each VP_ITEM As Integer In VP_INDICES
                    ...
                    While VP_REGISTRO <= PP_FORMA.VM_DATAGRID.Rows.Count - 1 And VP_BORRADO = 0
                        VP_VALOR = PP_FORMA.VM_DATAGRID.Rows(VP_REGISTRO).Cells("K_PARAMETRO_SUCURSAL").Value
...
#Region "EVENTOS"
    ...
    Private Sub LI_LISTADO_DoubleClick(sender As Object, e As EventArgs) Handles LI_LISTADO.CellDoubleClick
    ...
    Private Sub FO_PARAMETRO_SUCURSAL_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        PM_PARAMETRO_SUCURSAL_D0M4_FORMCLOSING(Me, LI_LISTADO, e)
    End Sub

    Private Sub FO_PARAMETRO_SUCURSAL_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        PM_FO_INIT(Me)
    End Sub
...
#Region "EVENTOS CHANGE VALUE DE LOS COMBOS DE ZONA"
    ...
    Private Sub TB_P1003_VENTA_KG_CONTADO_KeyUp(sender As Object, e As KeyEventArgs) Handles TB_P1003_VENTA_KG_CONTADO.KeyUp
        Dim VP_VALOR As Double
        Double.TryParse(sender.Text, VP_VALOR)
        If VP_VALOR >= 100 Then
            sender.Text = "100"
            TB_P1004_VENTA_KG_CREDITO.Text = "0"
        Else
            TB_P1004_VENTA_KG_CREDITO.Text = (100 - VP_VALOR).ToString()
        End If
    End Sub

    Private Sub TB_DESCUENTO_CONTADO_KeyUp(sender As Object, e As KeyEventArgs) Handles TB_DESCUENTO_CONTADO.KeyUp
        Dim VP_VALOR As Double
        Double.TryParse(sender.Text, VP_VALOR)
        If VP_VALOR >= 100 Then
            sender.Text = "100"
            TB_DESCUENTO_CREDITO.Text = "0"
        Else
            TB_DESCUENTO_CREDITO.Text = (100 - VP_VALOR).ToString()
        End If
    End Sub
