...
#Region "FUNCIONES_FM"
    ...
    Public Function FM_SQL_LISTADO() As String
        ...
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_LI_TIPO_ALMACEN, False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_LI_ESTATUS_ALMACEN, False)
    ...
    Public Function FM_FI_SQL(ByRef PP_NUEVO As Boolean)
        Dim VP_PARAMETROS = ""
        PP_NUEVO = True
        If TB_K_ALMACEN.Text <> "" Then
            Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, TB_K_ALMACEN, False)
            PP_NUEVO = False
        End If

        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, TB_D_ALMACEN, True)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_TIPO_ALMACEN, False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_ESTATUS_ALMACEN, False)
        ...
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, TB_C_ALMACEN, True)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, TB_CAPACIDAD_ALMACEN_LITROS, False)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, TB_NIVEL_ALMACEN_LITROS, False)
    ...
    Public Function FM_DESC_SELECCIONADO(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW As Integer) As String
        Dim VP_ID As String = ""
        VP_ID = Codigo_LI.FG_LI_CELL_READ(PP_LISTADO, PP_ROW, "D_ALMACEN")
        Return VP_ID
    End Function

    Public Function FM_ID_SELECCIONADO(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW As Integer) As String
        Dim VP_ID As String = ""
        VP_ID = Codigo_LI.FG_LI_CELL_READ(PP_LISTADO, PP_ROW, "K_ALMACEN")
        Return VP_ID
    End Function
    ...
    Public Function FM_SAVE_VALIDATE(ByRef PP_MENSAJE_VALIDACION As String) As Boolean
        ...
        Codigo_CTRL.PG_TB_NUMERIC_VALIDATE(PP_MENSAJE_VALIDACION, TB_CAPACIDAD_ALMACEN_LITROS)
        Codigo_CTRL.PG_TB_NUMERIC_VALIDATE(PP_MENSAJE_VALIDACION, TB_NIVEL_ALMACEN_LITROS)
...
#Region "SUB_PM_INIT"
    ...
    Public Sub PM_CB_INIT()
        ...
        Codigo_CB.PG_CB_LOAD_X_ORDEN(VM_ID_BASE_DE_DATOS, Me, CB_LI_TIPO_ALMACEN, "TIPO_ALMACEN")
        Codigo_CB.PG_CB_LOAD_X_ORDEN(VM_ID_BASE_DE_DATOS, Me, CB_LI_ESTATUS_ALMACEN, "ESTATUS_ALMACEN")
        'Codigo_CB.PG_CB_LOAD_X_DESCRIPCION(VM_ID_BASE_DE_DATOS, Me, CB_LI_UNIDAD_OPERATIVA, "UNIDAD_OPERATIVA")
        ...
        Codigo_CB.PG_CB_LOAD_X_ORDEN(VM_ID_BASE_DE_DATOS, Me, CB_TIPO_ALMACEN, "TIPO_ALMACEN")
        Codigo_CB.PG_CB_LOAD_X_ORDEN(VM_ID_BASE_DE_DATOS, Me, CB_ESTATUS_ALMACEN, "ESTATUS_ALMACEN")
        Codigo_CB.PG_CB_UNIDAD_OPERATIVA_Load(VM_ID_BASE_DE_DATOS, Me, CB_UNIDAD_OPERATIVA, 0, 0, New ComboBox, New ComboBox, VG_USUARIO_ACCION)
    End Sub
    ...
    Public Sub PM_DT_INIT()
        ...
        TB_LI_F_FINAL.Text = Codigo_ABC.FG_DT_CONVIERTE_FECHA_US_A_MX(VL_HOY.AddDays(-7))
    End Sub
    ...
    Public Sub PM_TB_INIT()
        Codigo_CTRL.PG_TB_INIT(TB_CAPACIDAD_ALMACEN_LITROS, 1)
        Codigo_CTRL.PG_TB_INIT(TB_NIVEL_ALMACEN_LITROS, 1)
    End Sub
...
#Region "SUBS_PM"
    ...
    Public Sub PM_FI_CARGAR(ByVal PP_ROW As DataRow)
        If VM_IN_MODO_OPERACION <> Modo_Operacion.Clon Then
            Codigo_CTRL.PG_CO_DATA_LOAD("", TB_K_ALMACEN, PP_ROW)
        ...
        Codigo_CTRL.PG_CO_DATA_LOAD("", TB_D_ALMACEN, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("", TB_C_ALMACEN, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("", TB_CAPACIDAD_ALMACEN_LITROS, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("", TB_NIVEL_ALMACEN_LITROS, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("", CB_TIPO_ALMACEN, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("", CB_ESTATUS_ALMACEN, PP_ROW)
    End Sub
    ...
    Private Sub PM_LI_FORMAT(ByRef PP_LI_LISTADO As DataGridView)
        ...
        '            PP_BOLD[0,1] 
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "K_ALMACEN", "#ALM", GetType(Integer), 60, 2, 0, 1, 1, 0, Color.White, Color.Black, 0)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D_UNIDAD_OPERATIVA", "Unidad Operativa", GetType(String), 130, 1, 0, 1, 1, 0, Color.DarkOrange, Nothing, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "S_ZONA_UO", "Zona", GetType(String), 60, 2, 0, 1, 0, 0, Color.DarkOrange, Nothing, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D_ALMACEN", "Almacen", GetType(Decimal), 150, 1, 0, 1, 0, 1, Nothing, Nothing, 1)
        'Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D_ZONA_UO", "Zona", GetType(String), 150, 2, 0, 1, 0, 0)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "S_TIPO_ALMACEN", "Tipo", GetType(String), 80, 2, 0, 1, 0, 0)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "S_ESTATUS_ALMACEN", "Estatus", GetType(String), 60, 2, 0, 1, 0, 0, Color.DarkSlateGray, Color.Gainsboro, 1)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "F_OPERACION_DDMMMYYYY", "Fecha", GetType(Date), 100, 2, 0, 1, 0, 0)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "UTILIZACION_ALMACEN_100", "% Utilización", GetType(Decimal), 80, 2, 0, 1, 0, 3, Color.Black, Color.LightYellow, 0)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "C_ALMACEN", "Comentario", GetType(Decimal), 150, 1, 0, 1, 0, 1)
    ...
    Public Sub PM_LI_ROW_WRITE(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW_DATA As DataRow)
        ...
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "K_ALMACEN")
        ...
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "D_ALMACEN")
        'Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "D_ZONA_UO")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "S_TIPO_ALMACEN")
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "S_ESTATUS_ALMACEN")
        ...
        Codigo_LI.PG_LI_CELL_WRITE_SECUENCIAL(PP_LISTADO, VP_ROW, VP_COLUMNA, PP_ROW_DATA, "C_ALMACEN")
