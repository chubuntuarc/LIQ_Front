Public Class UC_DOCUMENTO_D0M4
...
#Region "SUBS_PM"
    ...
    Public Sub PM_FI_CARGAR(ByVal PP_ROW As DataRow)
        ...
        FO_WIZARD.PP_K_DOCUMENTO_D0M4 = TB_K_DOCUMENTO_D0M4.Text 'CODEMAJIC
    End Sub
    ...
    Private Sub PM_BT_AGREGAR_CLICK(ByRef PP_FORMA As Object)
        ...
        Codigo_CB.PG_CB_VALUE_LOAD(CB_UNIDAD_OPERATIVA, FO_WIZARD.PP_UNIDAD_OPERATIVA)
        Codigo_CB.PG_CB_VALUE_LOAD(CB_TIEMPO_YYYY, FO_WIZARD.PP_YYYY)
        Codigo_CB.PG_CB_VALUE_LOAD(CB_MES, FO_WIZARD.PP_MES)
    End Sub
...
#Region "EVENTOS"
    ...
    Private Sub UC_DOCUMENTO_D0M4_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        If Me.Visible Then
            If FO_WIZARD.PP_K_DOCUMENTO_D0M4 > 0 Then
                VM_IN_MODO_OPERACION = Modo_Operacion.Edición
                PM_FI_LOAD(FO_WIZARD.PP_K_DOCUMENTO_D0M4)
                Codigo_FRM.PG_FRM_CONFIG(Me)

            ElseIf FO_WIZARD.PP_K_PRECIO_COSTO_PERFIL > 0 Then
                VM_IN_MODO_OPERACION = Modo_Operacion.Edición
                Codigo_FRM.PG_FRM_CONFIG(Me)
                Codigo_CB.PG_CB_VALUE_LOAD(CB_UNIDAD_OPERATIVA, FO_WIZARD.PP_UNIDAD_OPERATIVA)
                Codigo_CB.PG_CB_VALUE_LOAD(CB_TIEMPO_YYYY, FO_WIZARD.PP_YYYY)
