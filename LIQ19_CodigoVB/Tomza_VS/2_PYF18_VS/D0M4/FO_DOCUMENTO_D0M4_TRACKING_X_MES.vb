Public Class FO_DOCUMENTO_D0M4_TRACKING_X_MES
...
#Region "SUBS_PM"
    ...
    Private Sub PM_LI_FORMAT(ByRef PP_LI_LISTADO As DataGridView)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D_ZONA_UO", "ZONA OPERATIVA", GetType(Integer), 180, 1, 1, 1, 1, 0)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D_UNIDAD_OPERATIVA", "UNIDAD OPERATIVA", GetType(String), 140, 1, 1, 1, 1, 0)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "S_ZONA_UO", "SIGLA ZONA OPERATIVA", GetType(String), 200, 1, 1, 1, 1, 0)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "S_FORMATO_D0M4", "SIGLA FORMATO", GetType(String), 180, 2, 1, 1, 1, 0)
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "D_YYYY", "AÑO", GetType(String), 180, 2, 1, 1, 1, 0)
...
#Region "EVENTOS"
    ...
    Private Sub BT_EXPORTAR_EXCEL_Click_1(sender As Object, e As EventArgs)
    ...
    Private Sub BT_SALIR_Click_1(sender As Object, e As EventArgs)
