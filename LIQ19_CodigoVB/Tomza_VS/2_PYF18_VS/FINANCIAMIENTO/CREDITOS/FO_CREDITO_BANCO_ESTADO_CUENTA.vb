Public Class FO_CREDITO_BANCO_ESTADO_CUENTA
...
#Region "FUNCIONES_FM"
    ...
    Public Function FM_FI_SQL(ByRef PP_NUEVO As Boolean)
        ...
        End If
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, CB_TIPO_CALCULO_CREDITO, True)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, TB_MONTO_PRESTAMO, True)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, TB_TASA_INTERES_ANUAL, True)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, TB_CANTIDAD_PERIODOS, True)
        Codigo_CTRL.PG_CO_PARAMETRO(VP_PARAMETROS, DT_FECHA_INICIO, True)
    ...
    Public Function FM_ID_SELECCIONADO(ByRef PP_LISTADO As DataGridView, ByRef PP_ROW As Integer) As String
        Dim VP_ID As String = ""
        VP_ID = Codigo_LI.FG_LI_CELL_READ(PP_LISTADO, PP_ROW, "K_TABLA_AMORTIZACION")
        Return VP_ID
    End Function
...
#Region "SUBS_PM"
    ...
    Public Sub PM_FI_CARGAR(ByVal PP_ROW As DataRow)
        ...
        Codigo_CTRL.PG_CO_DATA_LOAD("", DT_FECHA_INICIO, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("", TB_CANTIDAD_PERIODOS, PP_ROW)
        Codigo_CTRL.PG_CO_DATA_LOAD("", TB_TASA_INTERES_ANUAL, PP_ROW)
    ...
    Private Sub PM_LI_FORMAT(ByRef PP_LI_LISTADO As DataGridView)
        ...
        Codigo_LI.PG_LI_COLUMN_ADD(PP_LI_LISTADO, "N_DIAS_PERIODO", "Días por Período", GetType(Integer), 60, 2, 0, 1, 0, 0)
    ...
    Private Sub PM_LI_LISTADO_DOUBLECLICK(ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        Dim VP_ID_AMORTIZACION As String
        ...
        Try
            If Codigo_LI.FG_LI_ROW_SELECTED(PP_LISTADO) Then
                ...
                Dim VP_ESTADO As New FO_CREDITO_BANCO_ESTADO("TABLA_AMORTIZACION", VG_ID_DB, VP_ID_AMORTIZACION)
                VP_ESTADO.ShowDialog()

                PM_BT_BUSCAR_CLICK(PP_FORMA, PP_LISTADO)

                'VP_ESTADO.PM_FO_SHOW("TABLA_AMORTIZACION", 2, VP_ID_AMORTIZACION)
...
#Region "EVENTOS"
    ...
    Private Sub BT_AGREGAR_Click(sender As Object, e As DataGridViewCellEventArgs)
    ...
    Private Sub LI_LISTADO_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles LI_LISTADO.CellDoubleClick
        If e.RowIndex <> -1 Then
            PM_LI_LISTADO_DOUBLECLICK(Me, LI_LISTADO)
        End If
    End Sub
