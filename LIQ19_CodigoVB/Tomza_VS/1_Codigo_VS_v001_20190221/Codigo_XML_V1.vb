...
Public Class Codigo_XML_V1
    ...
    Public Shared Function PG_OBTENER_ATRIBUTOS(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object) As List(Of XML)
    ...
    Public Shared Function FG_INSERTAR_FACTURA_XML(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_XML As XML, ByRef VP_ARCHIVO As String) As String
    ...
    'Este procedimiento es para Insertar los XML en la tabla //   AXR
    Public Shared Function FG_INSERTAR_FACTURA_XML(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_XML As XML, ByRef VP_ARCHIVO As String, ByRef PP_CLAVE As Integer) As String
        Dim VP_PARAMETROS As String = ""
        Dim VP_SP As String = ""
        Dim VP_TABLA As New Data.DataTable
        Dim VP_MENSAJE As String = ""
