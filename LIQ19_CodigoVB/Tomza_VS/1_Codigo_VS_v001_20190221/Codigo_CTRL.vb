Public Class Codigo_CTRL
    Public Shared Sub PG_CO_PARAMETRO(ByRef PP_PARAMETROS As String, ByVal PP_CONTROL As Object, ByVal PP_DELIMITADOR As Boolean)
        ...
        If PP_CONTROL.GetType() = GetType(MaskedTextBox) Then
            ...
            'Dim VL_FECHA As String() = TryCast(PP_CONTROL, MaskedTextBox).Text.Split("/")
            'Dim VL_DIA As String = VL_FECHA(0) : Dim VL_MES As String = VL_FECHA(1) : Dim VL_AÑO As String = VL_FECHA(2)
            'Dim VL_FECHA_VALIDAR As String = VL_DIA + "/" + VL_MES + "/" + VL_AÑO
            ...
            Else
                If VP_STRING_VALIDACION <> "" Then
                    Codigo_Message.PG_MENSAJE_AVISO(VP_STRING_VALIDACION)
                End If
                VP_VALOR = "NULL"
    ...
    Public Shared Sub PG_CO_DATA_LOAD_GENERICO(ByVal PP_NOMBRE_TABLA As String, ByRef PP_CONTROL As Control, ByVal PP_ROW As DataRow, Optional ByVal PP_VALOR_DEFAULT As String = "")
        Try
            ...
            Dim VP_VALOR As String = ""
            VP_VALOR = Codigo_CON.FG_CO_DATA_READ(PP_ROW, VP_NOMBRE_CAMPO, PP_VALOR_DEFAULT)
            ...
            If PP_CONTROL.GetType() = GetType(MaskedTextBox) And VP_NOMBRE_CAMPO Like "*F_*" Then
                ...
                VP_VALOR_FECHA = Codigo_CON.FG_CO_DATA_READ_FECHA(PP_ROW, VP_NOMBRE_CAMPO, PP_VALOR_DEFAULT)
                Dim VL_FECHA_MOSTRAR As String = VP_VALOR_FECHA.ToString("ddMMyyyy")
                PP_CONTROL.Text = VL_FECHA_MOSTRAR
            End If
