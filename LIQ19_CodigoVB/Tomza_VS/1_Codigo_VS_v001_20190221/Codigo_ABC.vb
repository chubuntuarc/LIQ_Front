...
#Region "EVENTOS_BOTONES"
    Public Shared Sub PG_BT_ELIMINAR_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView, Optional ByVal PP_SP As String = "")
        Dim VP_ID As String
        ...
        Try
            If Codigo_LI.FG_LI_ROW_SELECTED(PP_LISTADO) Then
                ...
                VP_DECISION = Codigo_Message.FG_MENSAJE_ELIMINAR(VP_ID, VP_NOM)
                ...
                If VP_DECISION Then
                    ...
                    Dim VP_SP As String
                    If PP_SP = "" Then
                        VP_SP = Codigo_CON.FG_SQL_LIST(PP_FORMA)
                    Else
                        VP_SP = PP_SP
                    End If

                    VP_SP = Codigo_CON.FG_SQL_DELETE(PP_FORMA)
                    ...
                    Codigo_LI.PG_LI_RESET(PP_ID_BASE_DE_DATOS, PP_FORMA, PP_LISTADO, VP_EXITO)
                End If
            End If
        Catch ex As Exception
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_ELIMINAR_CLICK")
        End Try
    End Sub

    Public Shared Sub PG_BT_BUSCAR_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView, Optional ByVal PP_SP As String = "")
    ...
    Public Shared Sub PG_BT_GUARDAR_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView, Optional ByVal PP_SP As String = "")
        Try
            ...
            Else
                ...
                Dim VP_DECISION As Boolean
                VP_DECISION = Codigo_Message.FG_MENSAJE_GUARDAR(VP_NUEVO)
    ...
    Public Shared Sub PG_BT_GUARDAR_ESPECIAL_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByVal PP_SP As String)
        Try
            Dim VP_MENSAJE_VALIDACION As String = ""
            Dim VP_VALIDACION As Boolean
            ...
            Else
                ...
                Dim VP_EXITO As Boolean = False
                VP_EXITO = Codigo_CON.FG_SQL_EJECUTAR_OPERACION(PP_FORMA, PP_ID_BASE_DE_DATOS, PP_SP, VP_PARAMETROS)

            End If

        Catch ex As Exception

            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_GUARDAR_ESPECIAL_CLICK")
        End Try


    End Sub

    Public Shared Sub PG_BT_EJECUTAR_ACCION_TABLA_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByVal PP_FORMA As Object, ByVal PP_SP As String, ByVal PP_PARAMETROS As String, ByRef PP_DATATABLE As Data.DataTable)
        Try

            Dim VP_PARAMETROS As String = PP_PARAMETROS
            Codigo_CON.PG_SQL_PARAMETROS_CONTROL(VP_PARAMETROS)
            PP_DATATABLE = Codigo_CON.FG_SP_EXECUTE_DATATABLE(PP_ID_BASE_DE_DATOS, PP_SP, VP_PARAMETROS)

        Catch ex As Exception

            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_EJECUTAR_ACCION_TABLA_CLICK")
        End Try

    End Sub

    Public Shared Sub PG_BT_EJECUTAR_ACCION_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByVal PP_FORMA As Object, ByVal PP_SP As String, ByVal PP_PARAMETROS As String, ByRef PP_CLAVE As Integer, ByRef PP_MENSAJE As String)
        Try
            ...
            VP_EXITO = Codigo_CON.FG_SQL_EJECUTAR_ACCION(PP_ID_BASE_DE_DATOS, PP_SP, VP_PARAMETROS, PP_CLAVE, PP_MENSAJE)

        Catch ex As Exception

            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_EJECUTAR_ACCION_CLICK")
        End Try

    End Sub

    Public Shared Sub PG_BT_INICIAR_SESION_CLICK(ByRef PP_FORMA As Object, ByRef PP_ID_DB As Integer)
        ...
        Try
            ...
            If VP_VALIDACION = False Then
                Codigo_Message.PG_MENSAJE_INFORMACION("No es posible acceder al sistema." + Environment.NewLine + Environment.NewLine + VP_MENSAJE_VALIDACION + Environment.NewLine + Environment.NewLine + "Por favor verifique.")
            Else
                ...
                Dim VP_SP As String
                VP_SP = Codigo_CON.FG_SQL_LOG()

                Codigo_CON.FG_CONNECTION_GET(PP_ID_DB)

                If VG_DESARROLLO = 1 Then
                    VP_SP = Codigo_CON.FG_SQL_LOG_DESARROLLO()
                ...
                Dim VP_EXITO As Boolean
                VP_EXITO = Codigo_CON.FG_SQL_EJECUTAR_ACCION(PP_ID_DB, VP_SP, VP_PARAMETROS)

                If VP_EXITO Then
                    Dim VP_BOARD As New FO_BOARD2()
                    VP_BOARD.PM_FO_SHOW()
                    PP_FORMA.Close()
                    VG_CULTURE_INFO = Codigo_CON.FG_CULTURE_INFO_GET(PP_ID_DB)
                End If

            End If
        Catch ex As Exception
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_INICIAR_SESION_CLICK")
        End Try
    End Sub
    ...
    Public Shared Sub PG_BT_EDITAR_CLICK(ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        ...
        Try
            ...
            If Codigo_LI.FG_LI_ROW_SELECTED(PP_LISTADO) Then
                If PP_FORMA.VM_IN_MODO_OPERACION = Modo_Operacion.Listado Then 'este if es por si esta en la lista y quiere cargar la ficha y editarla
                ...
                End If
                If PP_FORMA.VM_IN_MODO_OPERACION <> Modo_Operacion.Edición Then
                    PP_FORMA.VM_IN_MODO_OPERACION = Modo_Operacion.Edición
                    Codigo_FRM.PG_FRM_CONFIG(PP_FORMA)
                End If
            End If
        Catch ex As Exception
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_EDITAR_CLICK")
        End Try
    End Sub
    ...
    Public Shared Sub PG_BT_CLONAR_CLICK(ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        ...
        Try
            If Codigo_LI.FG_LI_ROW_SELECTED(PP_LISTADO) Then 'este if es por si esta en la lista y quiere cargar la ficha y editarla
                Dim VP_ROW As Integer = Codigo_LI.FG_LI_ROW_CURRENT(PP_LISTADO)
                VP_ID = PP_FORMA.FM_ID_SELECCIONADO(PP_LISTADO, VP_ROW)
                PP_FORMA.VM_IN_MODO_OPERACION = Modo_Operacion.Clon
                PP_FORMA.PM_FI_LOAD(VP_ID)
                Codigo_FRM.PG_FRM_CONFIG(PP_FORMA)
                PP_FORMA.VM_IN_MODO_OPERACION = Modo_Operacion.Edición
            End If
    ...
    Public Shared Sub PG_BT_AGREGAR_CLICK(ByRef PP_FORMA As Object)
        Try
            ...
            PP_FORMA.PM_FI_LOAD("")
        Catch ex As Exception
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_AGREGAR_CLICK")
        End Try
    End Sub
    ...
    Public Shared Sub PG_BT_EXPORTAR_EXCEL_CLICK(ByRef PP_LISTADO As DataGridView)
        ...
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("")
        End Try
    End Sub

    Public Shared Sub PG_BT_ACEPTAR_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView, Optional ByVal PP_SP As String = "")
        Try
            Dim VP_MENSAJE_VALIDACION As String = ""
            Dim VP_VALIDACION As Boolean
            ...
            Else
                ...
                If VP_NUEVO Then
                    VP_SP = Codigo_CON.FG_SQL_VERSION(PP_FORMA)
                Else
                    VP_SP = Codigo_CON.FG_SQL_UPDATE(PP_FORMA)
                End If
                ...
                Dim VP_EXITO As Boolean = False
                VP_EXITO = Codigo_CON.FG_SQL_EJECUTAR_ACCION(PP_ID_BASE_DE_DATOS, PP_FORMA, VP_SP, VP_PARAMETROS)
                If VP_EXITO Then
                    PP_FORMA.PM_LI_SAVE(PP_ID_BASE_DE_DATOS, PP_FORMA, PP_LISTADO)
                    Codigo_LI.PG_LI_RESET(PP_ID_BASE_DE_DATOS, PP_FORMA, PP_LISTADO, VP_EXITO)
            ...
            End If
        Catch ex As Exception
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_ACEPTAR_CLICK")
        End Try
    End Sub

    Public Shared Sub PG_BT_ANADIR_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        Try
            Dim VP_PARAMETROS As String
        ...
        Catch ex As Exception
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_ANADIR_CLICK")
        End Try
    End Sub

    Public Shared Sub PG_BT_ACTUALIZAR_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        Try
            Dim VP_PARAMETROS As String = ""
            ...
            Dim VP_SP As String
            VP_SP = Codigo_CON.FG_SQL_UP_VER(PP_FORMA)

            Dim VP_EXITO As Boolean = False
            VP_EXITO = Codigo_CON.FG_SQL_EJECUTAR_ACCION(PP_FORMA, PP_ID_BASE_DE_DATOS, PP_LISTADO, VP_SP, VP_PARAMETROS)

            PP_FORMA.PM_BT_BUSCAR_CLICK(PP_FORMA, PP_LISTADO)
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_ACTUALIZAR_CLICK")
        End Try
    End Sub
    ...
    Public Shared Sub PG_BT_NUEVO_CLICK(ByRef PP_FORMA As Object, ByVal PP_LISTADO As DataGridView)
        ...
        Try
            ...
            End If
        Catch ex As Exception
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_NUEVO_CLICK")
        End Try
    ...
    '    Dim VP_STORED_PROCEDURE As String
    '    VP_STORED_PROCEDURE = Codigo_CON.FG_SQL_LIST_MASIVO(PP_FORMA)
    ...
    Public Shared Sub PG_BT_BUSCAR_MASIVO_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        Try
            PP_FORMA.Cursor = Cursors.WaitCursor
            ...
            PP_FORMA.LB_RESULTADO.Text = "Resultado de la operación: " + VP_REGISTROS + " registros." + Environment.NewLine + PP_FORMA.LB_RESULTADO.Text
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_BUSCAR_MASIVO_CLICK")
        End Try

    End Sub

    Public Shared Sub PG_BT_LI_BUSCAR(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView, Optional ByVal PP_SP As String = "")
        Try
            PP_FORMA.Cursor = Cursors.WaitCursor
            ...
            Dim VP_STORED_PROCEDURE As String
            VP_STORED_PROCEDURE = Codigo_CON.FG_SQL_LIST_USUARIOS_GRUPO(PP_FORMA)

            If PP_SP <> "" Then
                VP_STORED_PROCEDURE = PP_SP
            End If

            PG_DATOS_SQL(PP_ID_BASE_DE_DATOS, PP_FORMA, PP_LISTADO, VP_STORED_PROCEDURE, VP_PARAMETROS)

        Catch ex As Exception
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_LI_BUSCAR")
        End Try
    End Sub

    Public Shared Sub PG_CB_GRUPO_SELECTIONCHANGEDCOMMINTTED(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        Try
            PP_FORMA.Cursor = Cursors.WaitCursor
        ...
        Catch ex As Exception
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_CB_GRUPO_SELECTIONCHANGEDCOMMINTTED")
        End Try
    End Sub

    Public Shared Sub PG_LI_LISTADO_GRUPO_CELLDOUBLECLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        ...
        Try
            If Codigo_LI.FG_LI_ROW_SELECTED(PP_LISTADO) Then
                ...
                Dim VP_STORED_PROCEDURE As String
                VP_STORED_PROCEDURE = Codigo_CON.FG_SQL_INSERT(PP_FORMA)

                Dim VP_EXITO As Boolean
                VP_EXITO = Codigo_CON.FG_SQL_EJECUTAR_OPERACION(PP_FORMA, PP_ID_BASE_DE_DATOS, VP_STORED_PROCEDURE, VP_PARAMETROS)
    ...
    Public Shared Sub PG_LI_LISTADO_CELLDOUBLECLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        Dim VP_PARAMETROS As String = ""
        Try
            ...
            If Codigo_LI.FG_LI_ROW_SELECTED(PP_LISTADO) Then
                ...
                Dim VP_STORED_PROCEDURE As String
                VP_STORED_PROCEDURE = Codigo_CON.FG_SQL_DELETE(PP_FORMA)
    ...
    Public Shared Sub PG_BT_ELIMINAR_MASIVO_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        ...
        Try
            ...
            Dim VP_EXITO As Boolean = False
            VP_TABLA = Codigo_CON.FG_SP_EXECUTE_DATATABLE(PP_ID_BASE_DE_DATOS, VP_SP, VP_PARAMETROS)
        ...
        Catch ex As Exception
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_ELIMINAR_MASIVO_CLICK")
        End Try
    End Sub

    Public Shared Sub PG_BT_GUARDAR_MASIVO_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        Try
        ...
        Catch ex As Exception
            ...
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_GUARDAR_MASIVO_CLICK")
        End Try
...
#Region "SUBS"
    ...
    Public Shared Sub PG_PORTAPAPELES_COPIAR(PP_LISTADO)
        Try
            ...
            End If
        Catch ex As Exception
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_PORTAPAPELES_COPIAR")
        End Try
    End Sub

    Public Shared Sub PG_DATOS_SQL(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView, ByVal PP_STORED_PROCEDURE As String, ByVal PP_PARAMETROS As String)
        Try
            Dim VP_TABLA As New Data.DataTable
            VP_TABLA = Codigo_CON.FG_SP_EXECUTE_DATATABLE(PP_ID_BASE_DE_DATOS, PP_STORED_PROCEDURE, PP_PARAMETROS)
            ...
            PP_FORMA.LB_RESULTADO.Text = "Resultado de la operación: " + VP_REGISTROS + " registros." + Environment.NewLine + PP_FORMA.LB_RESULTADO.Text
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_DATOS_SQL")
        End Try
    End Sub
    ...
    Public Shared Sub PG_SERIES_ADD(ByRef PP_CHART As System.Windows.Forms.DataVisualization.Charting.Chart, ByRef VP_TABLA As Data.DataTable)
        Try
            ...
            Next
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_SERIES_ADD")
        End Try
    End Sub
    ...
    Public Shared Sub PG_CLEAN_AND_TYPE(ByRef PP_CHART As System.Windows.Forms.DataVisualization.Charting.Chart, ByRef PP_TIPO_GRAFICO As String)
        Try
            ...
            End While
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_CLEAN_AND_TYPE")
        End Try
    End Sub

    Public Shared Sub PG_BT_GRAFICAR_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_CHART As System.Windows.Forms.DataVisualization.Charting.Chart, ByRef PP_TIPO_GRAFICO As String, PP_ID As String)
        Try
            PP_FORMA.Cursor = Cursors.WaitCursor
            Dim VP_PARAMETROS As String
            VP_PARAMETROS = PP_ID
            Codigo_CON.PG_SQL_PARAMETROS_CONTROL(VP_PARAMETROS)
            Dim VP_STORED_PROCEDURE As String
            VP_STORED_PROCEDURE = Codigo_CON.FG_SQL_GRAFICAR(PP_FORMA)
            Dim VP_TABLA As Data.DataTable
            VP_TABLA = Codigo_CON.FG_SP_EXECUTE_DATATABLE(PP_ID_BASE_DE_DATOS, VP_STORED_PROCEDURE, VP_PARAMETROS)
        ...
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_BT_GRAFICAR_CLICK")
        End Try
    End Sub

    Public Shared Sub PG_BT_GRAFICAR_CLICK(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByRef PP_CHART As System.Windows.Forms.DataVisualization.Charting.Chart, ByRef PP_TIPO_GRAFICO As String, PP_ID As String, PP_SP As String)
        Try
            PP_FORMA.Cursor = Cursors.WaitCursor
            Dim VP_PARAMETROS As String
            VP_PARAMETROS = PP_ID
    ...
    Public Shared Sub PG_LI_SAVE(ByRef PP_FORMA As Object, ByRef PP_LISTADO As DataGridView)
        Try
            ...
            PP_FORMA.PM_BT_BUSCAR_CLICK(PP_FORMA, PP_LISTADO)
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_LI_SAVE")
        End Try
    End Sub
...
#Region "FUNCIONES"
    ...
    Public Shared Function FG_DC_ID_SEARCH(ByVal PP_ID_BASE_DE_DATOS As Integer, ByRef PP_FORMA As Object, ByVal PP_KEY As String)
        Try
            Dim VP_ROW As DataRow = Nothing
            If PP_KEY <> "" Then
                Dim VP_RESULTADO As Data.DataTable
                Dim VP_SP As String
                VP_SP = Codigo_CON.FG_SQL_SEEK(PP_FORMA)

                Dim VP_PARAMETROS As String
                VP_PARAMETROS = PP_KEY
                Codigo_CON.PG_SQL_PARAMETROS_CONTROL(VP_PARAMETROS)

                VP_RESULTADO = Codigo_CON.FG_SP_EXECUTE_DATATABLE(PP_ID_BASE_DE_DATOS, VP_SP, VP_PARAMETROS)
            ...
            Return VP_ROW
        Catch ex As Exception
            Codigo_Message.PG_MENSAJE_ERROR_VS("PG_DC_ID_SEARCH")
        End Try
    ...
    Public Shared Function FG_COLUMN_NAME_GET(ByVal columnNumber As Integer) As String
        ...
        Try
            ...
            End While
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("FG_COLUMN_NAME_GET")
        End Try
        Return columnName
    End Function
    ...
    Public Shared Function FG_PARAMETROS_SQL(ByRef PP_FORMA As Object)
        ...
        Try
            ...
            Codigo_CON.PG_SQL_PARAMETROS_CONTROL(VP_PARAMETROS)
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("FG_PARAMETROS_SQL")
        End Try
    ...
    Public Shared Function VER_MOSTRAR(ByRef PP_FORMA As Object, ByVal PP_LISTADO As DataGridView, ByVal PP_MODO_OPERACION As Integer) As Boolean
        Try
            ...
            End If
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("VER_MOSTRAR")
        End Try
        Return False
    End Function
    ...
    Public Shared Function FG_DT_CONVIERTE_FECHA_MX_A_US(ByVal PP_FECHA As Date) As String ' Recibe una fecha en formato dd/mm/yyyy
        ...
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("FG_DT_CONVIERTE_FECHA_MX_A_US")
        End Try
    ...
    Public Shared Function FG_DT_CONVIERTE_FECHA_US_A_MX(ByVal PP_FECHA As Date) As String ' Recibe una fecha en formato mm/dd/yyyy
        ...
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("FG_DT_CONVIERTE_FECHA_US_A_MX")
        End Try
        Return VL_FECHA_MOSTRAR
    End Function
    ...
    Public Shared Function FG_DT_AGREGA_CEROS_FECHA_US(ByVal PP_FECHA As Date) As String ' Recibe una fecha en formato mm/dd/yyyy
        ...
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("FG_DT_AGREGA_CEROS_FECHA_US")
        End Try
        Return VL_FECHA_MOSTRAR
    End Function
    ...
    Public Shared Function FG_DT_CONVIERTE_FECHA_US_A_SQL(ByVal PP_FECHA As Date) As String ' Recibe una fecha en formato mm/dd/yyyy
        ...
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("FG_DT_CONVIERTE_FECHA_US_A_SQL")
        End Try
        Return VL_FECHA_MOSTRAR
    End Function
    Public Shared Function FG_DT_CONVIERTE_FECHA_XML_A_SQL(ByVal PP_FECHA As String) As String ' Recibe una fecha en formato mm/dd/yyyy
        ...
        Catch ex As ArgumentException
            Codigo_Message.PG_MENSAJE_ERROR_VS("FG_DT_CONVIERTE_FECHA_XML_A_SQL")
        End Try
        Return VL_FECHA_MOSTRAR
    End Function
